# e04-vdivu_vv-x-vadd_vv-m1-k30-ctrl [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_vdivu_vv_x_vadd_vv_m1_k30_ctrl_start
__yx_marker_e04_vdivu_vv_x_vadd_vv_m1_k30_ctrl_start:
    vdivu.vv v2, v0, v1   # producer
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_vdivu_vv_x_vadd_vv_m1_k30_ctrl_end
__yx_marker_e04_vdivu_vv_x_vadd_vv_m1_k30_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

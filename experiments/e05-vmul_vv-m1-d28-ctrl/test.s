# e05-vmul_vv-m1-d28-ctrl [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vmul_vv_m1_d28_ctrl_start
__yx_marker_e05_vmul_vv_m1_d28_ctrl_start:
    vmul.vv v2, v0, v1   # write1 -> v2
    ...
    vmul.vv v3, v4, v5   # write2 -> v3
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vmul_vv_m1_d28_ctrl_end
__yx_marker_e05_vmul_vv_m1_d28_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

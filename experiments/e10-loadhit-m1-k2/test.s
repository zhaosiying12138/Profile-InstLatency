...
1:
    ...
    .globl __yx_marker_e10_loadhit_m1_k2_start
__yx_marker_e10_loadhit_m1_k2_start:
    vle32.v v2, (x8)   # measured load
    add x21, x6, x7   # filler 0
    add x22, x6, x7   # filler 1
    vadd.vv v3, v2, v0   # consumer
    # TIMESTAMP_MARK end
    .globl __yx_marker_e10_loadhit_m1_k2_end
__yx_marker_e10_loadhit_m1_k2_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

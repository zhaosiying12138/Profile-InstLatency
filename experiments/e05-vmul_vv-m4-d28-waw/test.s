...
1:
    ...
    .globl __yx_marker_e05_vmul_vv_m4_d28_waw_start
__yx_marker_e05_vmul_vv_m4_d28_waw_start:
    ...
    vmul.vv v8, v16, v20   # write2 -> v8
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vmul_vv_m4_d28_waw_end
__yx_marker_e05_vmul_vv_m4_d28_waw_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

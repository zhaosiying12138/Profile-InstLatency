# e05-vredsum_vs-m2-d28-ctrl [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vredsum_vs_m2_d28_ctrl_start
__yx_marker_e05_vredsum_vs_m2_d28_ctrl_start:
    vredsum.vs v4, v0, v2   # write1 -> v4
    ...
    vredsum.vs v6, v8, v10   # write2 -> v6
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vredsum_vs_m2_d28_ctrl_end
__yx_marker_e05_vredsum_vs_m2_d28_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

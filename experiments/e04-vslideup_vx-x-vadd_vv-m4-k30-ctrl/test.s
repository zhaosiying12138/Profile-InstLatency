# e04-vslideup_vx-x-vadd_vv-m4-k30-ctrl [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_vslideup_vx_x_vadd_vv_m4_k30_ctrl_start
__yx_marker_e04_vslideup_vx_x_vadd_vv_m4_k30_ctrl_start:
    vslideup.vx v8, v0, x6   # producer
    ...
    add x22, x6, x7   # filler 25
    add x23, x6, x7   # filler 26
    add x24, x6, x7   # filler 27
    add x25, x6, x7   # filler 28
    add x26, x6, x7   # filler 29
    vadd.vv v12, v24, v4   # consumer vadd_vv
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_vslideup_vx_x_vadd_vv_m4_k30_ctrl_end
__yx_marker_e04_vslideup_vx_x_vadd_vv_m4_k30_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

...
1:
    ...
    .globl __yx_marker_e02_viota_m_m4_n4_start
__yx_marker_e02_viota_m_m4_n4_start:
    viota.m v8, v0   # stream 0
    viota.m v12, v0   # stream 1
    viota.m v16, v0   # stream 2
    viota.m v20, v0   # stream 3
    # TIMESTAMP_MARK end
    .globl __yx_marker_e02_viota_m_m4_n4_end
__yx_marker_e02_viota_m_m4_n4_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

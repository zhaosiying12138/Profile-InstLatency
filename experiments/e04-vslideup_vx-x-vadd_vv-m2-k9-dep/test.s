# e04-vslideup_vx-x-vadd_vv-m2-k9-dep [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_vslideup_vx_x_vadd_vv_m2_k9_dep_start
__yx_marker_e04_vslideup_vx_x_vadd_vv_m2_k9_dep_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_vslideup_vx_x_vadd_vv_m2_k9_dep_end
__yx_marker_e04_vslideup_vx_x_vadd_vv_m2_k9_dep_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

# e05-vredsum_vs-m1-d28-ctrl [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vredsum_vs_m1_d28_ctrl_start
__yx_marker_e05_vredsum_vs_m1_d28_ctrl_start:
    vredsum.vs v2, v0, v1   # write1 -> v2
    ...
    vredsum.vs v3, v4, v5   # write2 -> v3
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vredsum_vs_m1_d28_ctrl_end
__yx_marker_e05_vredsum_vs_m1_d28_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

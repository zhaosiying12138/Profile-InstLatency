# e04-vadd_vv-x-vadd_vv-m4-k30-ctrl [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_vadd_vv_x_vadd_vv_m4_k30_ctrl_start
__yx_marker_e04_vadd_vv_x_vadd_vv_m4_k30_ctrl_start:
    vadd.vv v8, v0, v4   # producer
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_vadd_vv_x_vadd_vv_m4_k30_ctrl_end
__yx_marker_e04_vadd_vv_x_vadd_vv_m4_k30_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

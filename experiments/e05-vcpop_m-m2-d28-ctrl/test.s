# e05-vcpop_m-m2-d28-ctrl [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vcpop_m_m2_d28_ctrl_start
__yx_marker_e05_vcpop_m_m2_d28_ctrl_start:
    vcpop.m x10, v0   # write1 -> v4
    ...
    vcpop.m x10, v8   # write2 -> v6
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vcpop_m_m2_d28_ctrl_end
__yx_marker_e05_vcpop_m_m2_d28_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

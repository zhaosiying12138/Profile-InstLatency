# e04-vcpop_m-x-scalar_add-m2-k8-dep [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_vcpop_m_x_scalar_add_m2_k8_dep_start
__yx_marker_e04_vcpop_m_x_scalar_add_m2_k8_dep_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_vcpop_m_x_scalar_add_m2_k8_dep_end
__yx_marker_e04_vcpop_m_x_scalar_add_m2_k8_dep_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

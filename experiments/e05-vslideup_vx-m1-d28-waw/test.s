# e05-vslideup_vx-m1-d28-waw [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vslideup_vx_m1_d28_waw_start
__yx_marker_e05_vslideup_vx_m1_d28_waw_start:
    ...
    vslideup.vx v2, v4, x6   # write2 -> v2
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vslideup_vx_m1_d28_waw_end
__yx_marker_e05_vslideup_vx_m1_d28_waw_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

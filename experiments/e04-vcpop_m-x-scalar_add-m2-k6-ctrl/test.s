# e04-vcpop_m-x-scalar_add-m2-k6-ctrl [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_vcpop_m_x_scalar_add_m2_k6_ctrl_start
__yx_marker_e04_vcpop_m_x_scalar_add_m2_k6_ctrl_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_vcpop_m_x_scalar_add_m2_k6_ctrl_end
__yx_marker_e04_vcpop_m_x_scalar_add_m2_k6_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

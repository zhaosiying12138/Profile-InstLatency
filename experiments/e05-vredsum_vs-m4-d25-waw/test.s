# e05-vredsum_vs-m4-d25-waw [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vredsum_vs_m4_d25_waw_start
__yx_marker_e05_vredsum_vs_m4_d25_waw_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vredsum_vs_m4_d25_waw_end
__yx_marker_e05_vredsum_vs_m4_d25_waw_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

# e04-vmseq_vv-x-vcpop_m-m2-k30-ctrl [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_vmseq_vv_x_vcpop_m_m2_k30_ctrl_start
__yx_marker_e04_vmseq_vv_x_vcpop_m_m2_k30_ctrl_start:
    vmseq.vv v4, v0, v2   # producer
    ...
    vcpop.m x11, 12   # mask consumer
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_vmseq_vv_x_vcpop_m_m2_k30_ctrl_end
__yx_marker_e04_vmseq_vv_x_vcpop_m_m2_k30_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

# e05-vredsum_vs-m2-d8-waw [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vredsum_vs_m2_d8_waw_start
__yx_marker_e05_vredsum_vs_m2_d8_waw_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vredsum_vs_m2_d8_waw_end
__yx_marker_e05_vredsum_vs_m2_d8_waw_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

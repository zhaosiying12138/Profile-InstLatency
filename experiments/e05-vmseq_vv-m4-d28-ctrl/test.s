# e05-vmseq_vv-m4-d28-ctrl [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vmseq_vv_m4_d28_ctrl_start
__yx_marker_e05_vmseq_vv_m4_d28_ctrl_start:
    vmseq.vv v8, v0, v4   # write1 -> v8
    ...
    vmseq.vv v12, v16, v20   # write2 -> v12
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vmseq_vv_m4_d28_ctrl_end
__yx_marker_e05_vmseq_vv_m4_d28_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

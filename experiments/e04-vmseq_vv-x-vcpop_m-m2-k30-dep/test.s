# e04-vmseq_vv-x-vcpop_m-m2-k30-dep [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_vmseq_vv_x_vcpop_m_m2_k30_dep_start
__yx_marker_e04_vmseq_vv_x_vcpop_m_m2_k30_dep_start:
    ...
    vcpop.m x11, 4   # mask consumer
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_vmseq_vv_x_vcpop_m_m2_k30_dep_end
__yx_marker_e04_vmseq_vv_x_vcpop_m_m2_k30_dep_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

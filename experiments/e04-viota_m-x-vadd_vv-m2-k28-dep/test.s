# e04-viota_m-x-vadd_vv-m2-k28-dep [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_viota_m_x_vadd_vv_m2_k28_dep_start
__yx_marker_e04_viota_m_x_vadd_vv_m2_k28_dep_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_viota_m_x_vadd_vv_m2_k28_dep_end
__yx_marker_e04_viota_m_x_vadd_vv_m2_k28_dep_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

...
1:
    ...
    .globl __yx_marker_e05_vadd_vv_m2_d28_waw_start
__yx_marker_e05_vadd_vv_m2_d28_waw_start:
    ...
    vadd.vv v4, v8, v10   # write2 -> v4
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vadd_vv_m2_d28_waw_end
__yx_marker_e05_vadd_vv_m2_d28_waw_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

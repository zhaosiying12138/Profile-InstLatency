# e05-vredsum_vs-m4-d28-waw [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vredsum_vs_m4_d28_waw_start
__yx_marker_e05_vredsum_vs_m4_d28_waw_start:
    ...
    vredsum.vs v8, v16, v20   # write2 -> v8
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vredsum_vs_m4_d28_waw_end
__yx_marker_e05_vredsum_vs_m4_d28_waw_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

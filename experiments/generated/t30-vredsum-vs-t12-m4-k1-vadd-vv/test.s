...
# experiment_id: t30-vredsum-vs-t12-m4-k1-vadd-vv
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_vredsum_vs_t12_m4_k1_vadd_vv_start, end=__rvv_profile_marker_t30_vredsum_vs_t12_m4_k1_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m4_k1_vadd_vv_start
    __rvv_profile_marker_t30_vredsum_vs_t12_m4_k1_vadd_vv_start:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m4_k1_vadd_vv_start:
    vredsum.vs v8, v0, v4
    vadd.vv v16, v0, v4  # independent filler 0
    vadd.vv v12, v8, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m4_k1_vadd_vv_end
    __rvv_profile_marker_t30_vredsum_vs_t12_m4_k1_vadd_vv_end:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m4_k1_vadd_vv_end:

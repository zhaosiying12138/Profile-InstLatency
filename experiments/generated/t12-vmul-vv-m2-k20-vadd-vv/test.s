...
# experiment_id: t12-vmul-vv-m2-k20-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t12_vmul_vv_m2_k20_vadd_vv_start, end=__rvv_profile_marker_t12_vmul_vv_m2_k20_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vmul_vv_m2_k20_vadd_vv_start
    __rvv_profile_marker_t12_vmul_vv_m2_k20_vadd_vv_start:
    .Lrvv_profile_marker_t12_vmul_vv_m2_k20_vadd_vv_start:
    vmul.vv v4, v0, v2
    ...
    .globl __rvv_profile_marker_t12_vmul_vv_m2_k20_vadd_vv_end
    __rvv_profile_marker_t12_vmul_vv_m2_k20_vadd_vv_end:
    .Lrvv_profile_marker_t12_vmul_vv_m2_k20_vadd_vv_end:

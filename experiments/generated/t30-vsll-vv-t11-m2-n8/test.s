...
# experiment_id: t30-vsll-vv-t11-m2-n8
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vsll_vv_t11_m2_n8_start, end=__rvv_profile_marker_t30_vsll_vv_t11_m2_n8_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vsll_vv_t11_m2_n8_start
    __rvv_profile_marker_t30_vsll_vv_t11_m2_n8_start:
    .Lrvv_profile_marker_t30_vsll_vv_t11_m2_n8_start:
    vsll.vv v4, v0, v2
    vsll.vv v4, v4, v2
    vsll.vv v4, v4, v2
    vsll.vv v4, v4, v2
    ...
    .globl __rvv_profile_marker_t30_vsll_vv_t11_m2_n8_end
    __rvv_profile_marker_t30_vsll_vv_t11_m2_n8_end:
    .Lrvv_profile_marker_t30_vsll_vv_t11_m2_n8_end:

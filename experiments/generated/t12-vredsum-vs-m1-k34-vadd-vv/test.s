...
# experiment_id: t12-vredsum-vs-m1-k34-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t12_vredsum_vs_m1_k34_vadd_vv_start, end=__rvv_profile_marker_t12_vredsum_vs_m1_k34_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vredsum_vs_m1_k34_vadd_vv_start
    __rvv_profile_marker_t12_vredsum_vs_m1_k34_vadd_vv_start:
    .Lrvv_profile_marker_t12_vredsum_vs_m1_k34_vadd_vv_start:
    vredsum.vs v2, v0, v1
    ...
    .globl __rvv_profile_marker_t12_vredsum_vs_m1_k34_vadd_vv_end
    __rvv_profile_marker_t12_vredsum_vs_m1_k34_vadd_vv_end:
    .Lrvv_profile_marker_t12_vredsum_vs_m1_k34_vadd_vv_end:

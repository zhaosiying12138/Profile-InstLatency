...
# experiment_id: t20-vsll-vv-viota-m-m1-n3
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vsll_vv_viota_m_m1_n3_start, end=__rvv_profile_marker_t20_vsll_vv_viota_m_m1_n3_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vsll_vv_viota_m_m1_n3_start
    __rvv_profile_marker_t20_vsll_vv_viota_m_m1_n3_start:
    .Lrvv_profile_marker_t20_vsll_vv_viota_m_m1_n3_start:
    vsll.vv v2, v0, v1
    viota.m v3, v0
    vsll.vv v4, v0, v1
    viota.m v5, v0
    ...
    .globl __rvv_profile_marker_t20_vsll_vv_viota_m_m1_n3_end
    __rvv_profile_marker_t20_vsll_vv_viota_m_m1_n3_end:
    .Lrvv_profile_marker_t20_vsll_vv_viota_m_m1_n3_end:

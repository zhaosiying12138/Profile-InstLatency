...
# experiment_id: t20-vcpop-m-vredsum-vs-m2-n6
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vcpop_m_vredsum_vs_m2_n6_start, end=__rvv_profile_marker_t20_vcpop_m_vredsum_vs_m2_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vcpop_m_vredsum_vs_m2_n6_start
    __rvv_profile_marker_t20_vcpop_m_vredsum_vs_m2_n6_start:
    .Lrvv_profile_marker_t20_vcpop_m_vredsum_vs_m2_n6_start:
    vcpop.m x10, v0
    vredsum.vs v4, v0, v2
    vcpop.m x11, v0
    vredsum.vs v6, v0, v2
    ...
    .globl __rvv_profile_marker_t20_vcpop_m_vredsum_vs_m2_n6_end
    __rvv_profile_marker_t20_vcpop_m_vredsum_vs_m2_n6_end:
    .Lrvv_profile_marker_t20_vcpop_m_vredsum_vs_m2_n6_end:

...
# experiment_id: t10-vdivu-vv-m4-n4
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t10_vdivu_vv_m4_n4_start, end=__rvv_profile_marker_t10_vdivu_vv_m4_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vdivu_vv_m4_n4_start
    __rvv_profile_marker_t10_vdivu_vv_m4_n4_start:
    .Lrvv_profile_marker_t10_vdivu_vv_m4_n4_start:
    vdivu.vv v8, v0, v4
    vdivu.vv v12, v0, v4
    vdivu.vv v16, v0, v4
    vdivu.vv v20, v0, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t10_vdivu_vv_m4_n4_end
    __rvv_profile_marker_t10_vdivu_vv_m4_n4_end:
    .Lrvv_profile_marker_t10_vdivu_vv_m4_n4_end:

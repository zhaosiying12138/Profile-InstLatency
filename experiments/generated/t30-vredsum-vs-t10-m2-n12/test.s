...
# experiment_id: t30-vredsum-vs-t10-m2-n12
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vredsum_vs_t10_m2_n12_start, end=__rvv_profile_marker_t30_vredsum_vs_t10_m2_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t10_m2_n12_start
    __rvv_profile_marker_t30_vredsum_vs_t10_m2_n12_start:
    .Lrvv_profile_marker_t30_vredsum_vs_t10_m2_n12_start:
    vredsum.vs v4, v0, v2
    vredsum.vs v6, v0, v2
    vredsum.vs v8, v0, v2
    ...
    vredsum.vs v20, v0, v2
    vredsum.vs v22, v0, v2
    vredsum.vs v24, v0, v2
    vredsum.vs v26, v0, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vredsum_vs_t10_m2_n12_end
    __rvv_profile_marker_t30_vredsum_vs_t10_m2_n12_end:
    .Lrvv_profile_marker_t30_vredsum_vs_t10_m2_n12_end:

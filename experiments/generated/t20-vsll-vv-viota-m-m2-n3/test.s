...
# experiment_id: t20-vsll-vv-viota-m-m2-n3
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vsll_vv_viota_m_m2_n3_start, end=__rvv_profile_marker_t20_vsll_vv_viota_m_m2_n3_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vsll_vv_viota_m_m2_n3_start
    __rvv_profile_marker_t20_vsll_vv_viota_m_m2_n3_start:
    .Lrvv_profile_marker_t20_vsll_vv_viota_m_m2_n3_start:
    vsll.vv v4, v0, v2
    viota.m v6, v0
    vsll.vv v8, v0, v2
    viota.m v10, v0
    ...
    .globl __rvv_profile_marker_t20_vsll_vv_viota_m_m2_n3_end
    __rvv_profile_marker_t20_vsll_vv_viota_m_m2_n3_end:
    .Lrvv_profile_marker_t20_vsll_vv_viota_m_m2_n3_end:

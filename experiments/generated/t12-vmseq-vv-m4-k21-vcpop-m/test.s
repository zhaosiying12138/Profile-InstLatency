...
# experiment_id: t12-vmseq-vv-m4-k21-vcpop-m
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t12_vmseq_vv_m4_k21_vcpop_m_start, end=__rvv_profile_marker_t12_vmseq_vv_m4_k21_vcpop_m_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vmseq_vv_m4_k21_vcpop_m_start
    __rvv_profile_marker_t12_vmseq_vv_m4_k21_vcpop_m_start:
    .Lrvv_profile_marker_t12_vmseq_vv_m4_k21_vcpop_m_start:
    vmseq.vv v8, v0, v4
    ...
    .globl __rvv_profile_marker_t12_vmseq_vv_m4_k21_vcpop_m_end
    __rvv_profile_marker_t12_vmseq_vv_m4_k21_vcpop_m_end:
    .Lrvv_profile_marker_t12_vmseq_vv_m4_k21_vcpop_m_end:

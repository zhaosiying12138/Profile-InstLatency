...
# experiment_id: t30-vslideup-vx-t12-m1-k0
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vslideup_vx_t12_m1_k0_start, end=__rvv_profile_marker_t30_vslideup_vx_t12_m1_k0_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vslideup_vx_t12_m1_k0_start
    __rvv_profile_marker_t30_vslideup_vx_t12_m1_k0_start:
    .Lrvv_profile_marker_t30_vslideup_vx_t12_m1_k0_start:
    vslideup.vx v2, v0, x6
    vadd.vv v3, v2, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vslideup_vx_t12_m1_k0_end
    __rvv_profile_marker_t30_vslideup_vx_t12_m1_k0_end:
    .Lrvv_profile_marker_t30_vslideup_vx_t12_m1_k0_end:

...
# experiment_id: t20-vadd-vv-vmul-vv-m2-n3
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vadd_vv_vmul_vv_m2_n3_start, end=__rvv_profile_marker_t20_vadd_vv_vmul_vv_m2_n3_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vmul_vv_m2_n3_start
    __rvv_profile_marker_t20_vadd_vv_vmul_vv_m2_n3_start:
    .Lrvv_profile_marker_t20_vadd_vv_vmul_vv_m2_n3_start:
    vadd.vv v4, v0, v2
    vmul.vv v6, v0, v2
    vadd.vv v8, v0, v2
    vmul.vv v10, v0, v2
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vmul_vv_m2_n3_end
    __rvv_profile_marker_t20_vadd_vv_vmul_vv_m2_n3_end:
    .Lrvv_profile_marker_t20_vadd_vv_vmul_vv_m2_n3_end:

...
# experiment_id: t30-vredsum-vs-t12-m4-k17
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_vredsum_vs_t12_m4_k17_start, end=__rvv_profile_marker_t30_vredsum_vs_t12_m4_k17_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m4_k17_start
    __rvv_profile_marker_t30_vredsum_vs_t12_m4_k17_start:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m4_k17_start:
    vredsum.vs v8, v0, v4
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m4_k17_end
    __rvv_profile_marker_t30_vredsum_vs_t12_m4_k17_end:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m4_k17_end:

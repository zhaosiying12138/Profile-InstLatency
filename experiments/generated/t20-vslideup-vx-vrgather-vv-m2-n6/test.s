...
# experiment_id: t20-vslideup-vx-vrgather-vv-m2-n6
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m2_n6_start, end=__rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m2_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m2_n6_start
    __rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m2_n6_start:
    .Lrvv_profile_marker_t20_vslideup_vx_vrgather_vv_m2_n6_start:
    vslideup.vx v4, v0, x6
    vrgather.vv v6, v0, v2
    vslideup.vx v8, v0, x6
    vrgather.vv v10, v0, v2
    vslideup.vx v12, v0, x6
    vrgather.vv v14, v0, v2
    vslideup.vx v16, v0, x6
    vrgather.vv v18, v0, v2
    vslideup.vx v20, v0, x6
    vrgather.vv v22, v0, v2
    vslideup.vx v24, v0, x6
    vrgather.vv v26, v0, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m2_n6_end
    __rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m2_n6_end:
    .Lrvv_profile_marker_t20_vslideup_vx_vrgather_vv_m2_n6_end:

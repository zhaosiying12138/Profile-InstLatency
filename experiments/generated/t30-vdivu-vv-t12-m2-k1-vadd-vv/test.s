...
# experiment_id: t30-vdivu-vv-t12-m2-k1-vadd-vv
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vdivu_vv_t12_m2_k1_vadd_vv_start, end=__rvv_profile_marker_t30_vdivu_vv_t12_m2_k1_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vdivu_vv_t12_m2_k1_vadd_vv_start
    __rvv_profile_marker_t30_vdivu_vv_t12_m2_k1_vadd_vv_start:
    .Lrvv_profile_marker_t30_vdivu_vv_t12_m2_k1_vadd_vv_start:
    vdivu.vv v4, v0, v2
    vadd.vv v8, v0, v2  # independent filler 0
    vadd.vv v6, v4, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vdivu_vv_t12_m2_k1_vadd_vv_end
    __rvv_profile_marker_t30_vdivu_vv_t12_m2_k1_vadd_vv_end:
    .Lrvv_profile_marker_t30_vdivu_vv_t12_m2_k1_vadd_vv_end:

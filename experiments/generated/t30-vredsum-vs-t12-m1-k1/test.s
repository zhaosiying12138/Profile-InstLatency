...
# experiment_id: t30-vredsum-vs-t12-m1-k1
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vredsum_vs_t12_m1_k1_start, end=__rvv_profile_marker_t30_vredsum_vs_t12_m1_k1_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m1_k1_start
    __rvv_profile_marker_t30_vredsum_vs_t12_m1_k1_start:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m1_k1_start:
    vredsum.vs v2, v0, v1
    vadd.vv v4, v0, v1  # independent filler 0
    vadd.vv v3, v2, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m1_k1_end
    __rvv_profile_marker_t30_vredsum_vs_t12_m1_k1_end:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m1_k1_end:

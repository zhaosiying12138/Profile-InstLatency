...
# experiment_id: t12-vadd-vv-m4-k18-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t12_vadd_vv_m4_k18_vadd_vv_start, end=__rvv_profile_marker_t12_vadd_vv_m4_k18_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vadd_vv_m4_k18_vadd_vv_start
    __rvv_profile_marker_t12_vadd_vv_m4_k18_vadd_vv_start:
    .Lrvv_profile_marker_t12_vadd_vv_m4_k18_vadd_vv_start:
    vadd.vv v8, v0, v4
    ...
    .globl __rvv_profile_marker_t12_vadd_vv_m4_k18_vadd_vv_end
    __rvv_profile_marker_t12_vadd_vv_m4_k18_vadd_vv_end:
    .Lrvv_profile_marker_t12_vadd_vv_m4_k18_vadd_vv_end:

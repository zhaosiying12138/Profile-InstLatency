...
# experiment_id: t10-vsll-vv-m1-n4
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t10_vsll_vv_m1_n4_start, end=__rvv_profile_marker_t10_vsll_vv_m1_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vsll_vv_m1_n4_start
    __rvv_profile_marker_t10_vsll_vv_m1_n4_start:
    .Lrvv_profile_marker_t10_vsll_vv_m1_n4_start:
    vsll.vv v2, v0, v1
    vsll.vv v3, v0, v1
    vsll.vv v4, v0, v1
    vsll.vv v5, v0, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t10_vsll_vv_m1_n4_end
    __rvv_profile_marker_t10_vsll_vv_m1_n4_end:
    .Lrvv_profile_marker_t10_vsll_vv_m1_n4_end:

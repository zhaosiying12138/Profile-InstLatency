...
# experiment_id: t30-vmseq-vv-t12-m2-k0-vcpop-m
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vmseq_vv_t12_m2_k0_vcpop_m_start, end=__rvv_profile_marker_t30_vmseq_vv_t12_m2_k0_vcpop_m_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmseq_vv_t12_m2_k0_vcpop_m_start
    __rvv_profile_marker_t30_vmseq_vv_t12_m2_k0_vcpop_m_start:
    .Lrvv_profile_marker_t30_vmseq_vv_t12_m2_k0_vcpop_m_start:
    vmseq.vv v4, v0, v2
    vcpop.m x11, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vmseq_vv_t12_m2_k0_vcpop_m_end
    __rvv_profile_marker_t30_vmseq_vv_t12_m2_k0_vcpop_m_end:
    .Lrvv_profile_marker_t30_vmseq_vv_t12_m2_k0_vcpop_m_end:

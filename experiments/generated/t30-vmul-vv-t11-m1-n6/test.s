...
# experiment_id: t30-vmul-vv-t11-m1-n6
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vmul_vv_t11_m1_n6_start, end=__rvv_profile_marker_t30_vmul_vv_t11_m1_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t11_m1_n6_start
    __rvv_profile_marker_t30_vmul_vv_t11_m1_n6_start:
    .Lrvv_profile_marker_t30_vmul_vv_t11_m1_n6_start:
    vmul.vv v2, v0, v1
    vmul.vv v2, v2, v1
    vmul.vv v2, v2, v1
    vmul.vv v2, v2, v1
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t11_m1_n6_end
    __rvv_profile_marker_t30_vmul_vv_t11_m1_n6_end:
    .Lrvv_profile_marker_t30_vmul_vv_t11_m1_n6_end:

...
# experiment_id: t20-vrgather-vv-vredsum-vs-m2-n6
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vrgather_vv_vredsum_vs_m2_n6_start, end=__rvv_profile_marker_t20_vrgather_vv_vredsum_vs_m2_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vrgather_vv_vredsum_vs_m2_n6_start
    __rvv_profile_marker_t20_vrgather_vv_vredsum_vs_m2_n6_start:
    .Lrvv_profile_marker_t20_vrgather_vv_vredsum_vs_m2_n6_start:
    ...
    vredsum.vs v22, v0, v2
    vrgather.vv v24, v0, v2
    vredsum.vs v26, v0, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vrgather_vv_vredsum_vs_m2_n6_end
    __rvv_profile_marker_t20_vrgather_vv_vredsum_vs_m2_n6_end:
    .Lrvv_profile_marker_t20_vrgather_vv_vredsum_vs_m2_n6_end:

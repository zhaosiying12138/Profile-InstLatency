...
# experiment_id: t30-vredsum-vs-t12-m2-k0
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vredsum_vs_t12_m2_k0_start, end=__rvv_profile_marker_t30_vredsum_vs_t12_m2_k0_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m2_k0_start
    __rvv_profile_marker_t30_vredsum_vs_t12_m2_k0_start:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m2_k0_start:
    vredsum.vs v4, v0, v2
    vadd.vv v6, v4, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m2_k0_end
    __rvv_profile_marker_t30_vredsum_vs_t12_m2_k0_end:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m2_k0_end:

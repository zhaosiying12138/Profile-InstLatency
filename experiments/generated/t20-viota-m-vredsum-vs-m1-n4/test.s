...
# experiment_id: t20-viota-m-vredsum-vs-m1-n4
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_viota_m_vredsum_vs_m1_n4_start, end=__rvv_profile_marker_t20_viota_m_vredsum_vs_m1_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_viota_m_vredsum_vs_m1_n4_start
    __rvv_profile_marker_t20_viota_m_vredsum_vs_m1_n4_start:
    .Lrvv_profile_marker_t20_viota_m_vredsum_vs_m1_n4_start:
    viota.m v2, v0
    vredsum.vs v3, v0, v1
    viota.m v4, v0
    vredsum.vs v5, v0, v1
    ...
    .globl __rvv_profile_marker_t20_viota_m_vredsum_vs_m1_n4_end
    __rvv_profile_marker_t20_viota_m_vredsum_vs_m1_n4_end:
    .Lrvv_profile_marker_t20_viota_m_vredsum_vs_m1_n4_end:

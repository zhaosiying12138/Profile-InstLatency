...
# experiment_id: t30-vmul-vv-t12-m1-k0-vadd-vv
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vmul_vv_t12_m1_k0_vadd_vv_start, end=__rvv_profile_marker_t30_vmul_vv_t12_m1_k0_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t12_m1_k0_vadd_vv_start
    __rvv_profile_marker_t30_vmul_vv_t12_m1_k0_vadd_vv_start:
    .Lrvv_profile_marker_t30_vmul_vv_t12_m1_k0_vadd_vv_start:
    vmul.vv v2, v0, v1
    vadd.vv v3, v2, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vmul_vv_t12_m1_k0_vadd_vv_end
    __rvv_profile_marker_t30_vmul_vv_t12_m1_k0_vadd_vv_end:
    .Lrvv_profile_marker_t30_vmul_vv_t12_m1_k0_vadd_vv_end:

...
# experiment_id: t20-vmseq-vv-vredsum-vs-m4-n3-resource-noreuse
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m4_n3_resource_noreuse_start, end=__rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m4_n3_resource_noreuse_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m4_n3_resource_noreuse_start
    __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m4_n3_resource_noreuse_start:
    .Lrvv_profile_marker_t20_vmseq_vv_vredsum_vs_m4_n3_resource_noreuse_start:
    vmseq.vv v8, v0, v4
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m4_n3_resource_noreuse_end
    __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m4_n3_resource_noreuse_end:
    .Lrvv_profile_marker_t20_vmseq_vv_vredsum_vs_m4_n3_resource_noreuse_end:

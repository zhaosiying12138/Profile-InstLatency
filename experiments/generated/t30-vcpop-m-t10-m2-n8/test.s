...
# experiment_id: t30-vcpop-m-t10-m2-n8
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vcpop_m_t10_m2_n8_start, end=__rvv_profile_marker_t30_vcpop_m_t10_m2_n8_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vcpop_m_t10_m2_n8_start
    __rvv_profile_marker_t30_vcpop_m_t10_m2_n8_start:
    .Lrvv_profile_marker_t30_vcpop_m_t10_m2_n8_start:
    vcpop.m x10, v0
    vcpop.m x11, v0
    vcpop.m x12, v0
    vcpop.m x13, v0
    ...
    .globl __rvv_profile_marker_t30_vcpop_m_t10_m2_n8_end
    __rvv_profile_marker_t30_vcpop_m_t10_m2_n8_end:
    .Lrvv_profile_marker_t30_vcpop_m_t10_m2_n8_end:

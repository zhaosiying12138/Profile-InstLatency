...
# experiment_id: t30-vslideup-vx-t12-m1-k40-vadd-vv
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vslideup_vx_t12_m1_k40_vadd_vv_start, end=__rvv_profile_marker_t30_vslideup_vx_t12_m1_k40_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vslideup_vx_t12_m1_k40_vadd_vv_start
    __rvv_profile_marker_t30_vslideup_vx_t12_m1_k40_vadd_vv_start:
    .Lrvv_profile_marker_t30_vslideup_vx_t12_m1_k40_vadd_vv_start:
    ...
    vadd.vv v9, v0, v1  # independent filler 33
    vadd.vv v10, v0, v1  # independent filler 34
    vadd.vv v11, v0, v1  # independent filler 35
    vadd.vv v12, v0, v1  # independent filler 36
    vadd.vv v13, v0, v1  # independent filler 37
    vadd.vv v14, v0, v1  # independent filler 38
    vadd.vv v15, v0, v1  # independent filler 39
    vadd.vv v3, v2, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vslideup_vx_t12_m1_k40_vadd_vv_end
    __rvv_profile_marker_t30_vslideup_vx_t12_m1_k40_vadd_vv_end:
    .Lrvv_profile_marker_t30_vslideup_vx_t12_m1_k40_vadd_vv_end:

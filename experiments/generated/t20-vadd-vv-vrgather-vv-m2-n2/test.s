...
# experiment_id: t20-vadd-vv-vrgather-vv-m2-n2
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vadd_vv_vrgather_vv_m2_n2_start, end=__rvv_profile_marker_t20_vadd_vv_vrgather_vv_m2_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vrgather_vv_m2_n2_start
    __rvv_profile_marker_t20_vadd_vv_vrgather_vv_m2_n2_start:
    .Lrvv_profile_marker_t20_vadd_vv_vrgather_vv_m2_n2_start:
    vadd.vv v4, v0, v2
    vrgather.vv v6, v0, v2
    vadd.vv v8, v0, v2
    vrgather.vv v10, v0, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vadd_vv_vrgather_vv_m2_n2_end
    __rvv_profile_marker_t20_vadd_vv_vrgather_vv_m2_n2_end:
    .Lrvv_profile_marker_t20_vadd_vv_vrgather_vv_m2_n2_end:

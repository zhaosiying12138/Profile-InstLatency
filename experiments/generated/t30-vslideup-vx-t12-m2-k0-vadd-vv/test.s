...
# experiment_id: t30-vslideup-vx-t12-m2-k0-vadd-vv
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vslideup_vx_t12_m2_k0_vadd_vv_start, end=__rvv_profile_marker_t30_vslideup_vx_t12_m2_k0_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vslideup_vx_t12_m2_k0_vadd_vv_start
    __rvv_profile_marker_t30_vslideup_vx_t12_m2_k0_vadd_vv_start:
    .Lrvv_profile_marker_t30_vslideup_vx_t12_m2_k0_vadd_vv_start:
    vslideup.vx v4, v0, x6
    vadd.vv v6, v4, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vslideup_vx_t12_m2_k0_vadd_vv_end
    __rvv_profile_marker_t30_vslideup_vx_t12_m2_k0_vadd_vv_end:
    .Lrvv_profile_marker_t30_vslideup_vx_t12_m2_k0_vadd_vv_end:

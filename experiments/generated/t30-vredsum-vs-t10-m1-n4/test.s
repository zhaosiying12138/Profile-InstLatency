...
# experiment_id: t30-vredsum-vs-t10-m1-n4
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vredsum_vs_t10_m1_n4_start, end=__rvv_profile_marker_t30_vredsum_vs_t10_m1_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t10_m1_n4_start
    __rvv_profile_marker_t30_vredsum_vs_t10_m1_n4_start:
    .Lrvv_profile_marker_t30_vredsum_vs_t10_m1_n4_start:
    vredsum.vs v2, v0, v1
    vredsum.vs v3, v0, v1
    vredsum.vs v4, v0, v1
    vredsum.vs v5, v0, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vredsum_vs_t10_m1_n4_end
    __rvv_profile_marker_t30_vredsum_vs_t10_m1_n4_end:
    .Lrvv_profile_marker_t30_vredsum_vs_t10_m1_n4_end:

...
# experiment_id: t20-vmul-vv-vredsum-vs-m4-n3
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vmul_vv_vredsum_vs_m4_n3_start, end=__rvv_profile_marker_t20_vmul_vv_vredsum_vs_m4_n3_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m4_n3_start
    __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m4_n3_start:
    .Lrvv_profile_marker_t20_vmul_vv_vredsum_vs_m4_n3_start:
    vmul.vv v8, v0, v4
    ...
    .globl __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m4_n3_end
    __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m4_n3_end:
    .Lrvv_profile_marker_t20_vmul_vv_vredsum_vs_m4_n3_end:

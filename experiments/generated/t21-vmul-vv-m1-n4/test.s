...
# experiment_id: t21-vmul-vv-m1-n4
# template_id: T21_PAIR_WITH_SCALAR
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t21_vmul_vv_m1_n4_start, end=__rvv_profile_marker_t21_vmul_vv_m1_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t21_vmul_vv_m1_n4_start
    __rvv_profile_marker_t21_vmul_vv_m1_n4_start:
    .Lrvv_profile_marker_t21_vmul_vv_m1_n4_start:
    vmul.vv v2, v0, v1
    add x20, x21, x22
    vmul.vv v3, v0, v1
    add x23, x24, x25
    ...
    .globl __rvv_profile_marker_t21_vmul_vv_m1_n4_end
    __rvv_profile_marker_t21_vmul_vv_m1_n4_end:
    .Lrvv_profile_marker_t21_vmul_vv_m1_n4_end:

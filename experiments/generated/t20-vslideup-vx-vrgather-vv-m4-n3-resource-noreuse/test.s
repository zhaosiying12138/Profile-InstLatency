...
# experiment_id: t20-vslideup-vx-vrgather-vv-m4-n3-resource-noreuse
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m4_n3_resource_noreuse_start, end=__rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m4_n3_resource_noreuse_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m4_n3_resource_noreuse_start
    __rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m4_n3_resource_noreuse_start:
    .Lrvv_profile_marker_t20_vslideup_vx_vrgather_vv_m4_n3_resource_noreuse_start:
    vslideup.vx v8, v0, x6
    vrgather.vv v12, v0, v4
    vslideup.vx v16, v0, x6
    vrgather.vv v20, v0, v4
    vslideup.vx v24, v0, x6
    vrgather.vv v28, v0, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m4_n3_resource_noreuse_end
    __rvv_profile_marker_t20_vslideup_vx_vrgather_vv_m4_n3_resource_noreuse_end:
    .Lrvv_profile_marker_t20_vslideup_vx_vrgather_vv_m4_n3_resource_noreuse_end:

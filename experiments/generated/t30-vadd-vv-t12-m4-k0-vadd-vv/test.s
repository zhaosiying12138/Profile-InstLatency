...
# experiment_id: t30-vadd-vv-t12-m4-k0-vadd-vv
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_vadd_vv_t12_m4_k0_vadd_vv_start, end=__rvv_profile_marker_t30_vadd_vv_t12_m4_k0_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t12_m4_k0_vadd_vv_start
    __rvv_profile_marker_t30_vadd_vv_t12_m4_k0_vadd_vv_start:
    .Lrvv_profile_marker_t30_vadd_vv_t12_m4_k0_vadd_vv_start:
    vadd.vv v8, v0, v4
    vadd.vv v12, v8, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vadd_vv_t12_m4_k0_vadd_vv_end
    __rvv_profile_marker_t30_vadd_vv_t12_m4_k0_vadd_vv_end:
    .Lrvv_profile_marker_t30_vadd_vv_t12_m4_k0_vadd_vv_end:

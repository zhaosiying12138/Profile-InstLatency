...
# experiment_id: t30-viota-m-t12-m4-k1
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_viota_m_t12_m4_k1_start, end=__rvv_profile_marker_t30_viota_m_t12_m4_k1_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_viota_m_t12_m4_k1_start
    __rvv_profile_marker_t30_viota_m_t12_m4_k1_start:
    .Lrvv_profile_marker_t30_viota_m_t12_m4_k1_start:
    viota.m v8, v0
    vadd.vv v16, v0, v4  # independent filler 0
    vadd.vv v12, v8, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_viota_m_t12_m4_k1_end
    __rvv_profile_marker_t30_viota_m_t12_m4_k1_end:
    .Lrvv_profile_marker_t30_viota_m_t12_m4_k1_end:

...
# experiment_id: t12-vsll-vv-m2-k16-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t12_vsll_vv_m2_k16_vadd_vv_start, end=__rvv_profile_marker_t12_vsll_vv_m2_k16_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vsll_vv_m2_k16_vadd_vv_start
    __rvv_profile_marker_t12_vsll_vv_m2_k16_vadd_vv_start:
    .Lrvv_profile_marker_t12_vsll_vv_m2_k16_vadd_vv_start:
    vsll.vv v4, v0, v2
    ...
    .globl __rvv_profile_marker_t12_vsll_vv_m2_k16_vadd_vv_end
    __rvv_profile_marker_t12_vsll_vv_m2_k16_vadd_vv_end:
    .Lrvv_profile_marker_t12_vsll_vv_m2_k16_vadd_vv_end:

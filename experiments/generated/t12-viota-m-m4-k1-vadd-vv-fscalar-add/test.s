...
# experiment_id: t12-viota-m-m4-k1-vadd-vv-fscalar-add
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t12_viota_m_m4_k1_vadd_vv_fscalar_add_start, end=__rvv_profile_marker_t12_viota_m_m4_k1_vadd_vv_fscalar_add_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_viota_m_m4_k1_vadd_vv_fscalar_add_start
    __rvv_profile_marker_t12_viota_m_m4_k1_vadd_vv_fscalar_add_start:
    .Lrvv_profile_marker_t12_viota_m_m4_k1_vadd_vv_fscalar_add_start:
    viota.m v8, v0
    add x20, x6, x7  # independent scalar filler 0
    vadd.vv v12, v8, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t12_viota_m_m4_k1_vadd_vv_fscalar_add_end
    __rvv_profile_marker_t12_viota_m_m4_k1_vadd_vv_fscalar_add_end:
    .Lrvv_profile_marker_t12_viota_m_m4_k1_vadd_vv_fscalar_add_end:

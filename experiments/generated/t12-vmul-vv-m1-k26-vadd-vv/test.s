...
# experiment_id: t12-vmul-vv-m1-k26-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t12_vmul_vv_m1_k26_vadd_vv_start, end=__rvv_profile_marker_t12_vmul_vv_m1_k26_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vmul_vv_m1_k26_vadd_vv_start
    __rvv_profile_marker_t12_vmul_vv_m1_k26_vadd_vv_start:
    .Lrvv_profile_marker_t12_vmul_vv_m1_k26_vadd_vv_start:
    vmul.vv v2, v0, v1
    ...
    .globl __rvv_profile_marker_t12_vmul_vv_m1_k26_vadd_vv_end
    __rvv_profile_marker_t12_vmul_vv_m1_k26_vadd_vv_end:
    .Lrvv_profile_marker_t12_vmul_vv_m1_k26_vadd_vv_end:

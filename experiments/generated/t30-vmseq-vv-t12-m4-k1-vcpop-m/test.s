...
# experiment_id: t30-vmseq-vv-t12-m4-k1-vcpop-m
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_vmseq_vv_t12_m4_k1_vcpop_m_start, end=__rvv_profile_marker_t30_vmseq_vv_t12_m4_k1_vcpop_m_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmseq_vv_t12_m4_k1_vcpop_m_start
    __rvv_profile_marker_t30_vmseq_vv_t12_m4_k1_vcpop_m_start:
    .Lrvv_profile_marker_t30_vmseq_vv_t12_m4_k1_vcpop_m_start:
    vmseq.vv v8, v0, v4
    vadd.vv v16, v0, v4  # independent filler 0
    vcpop.m x11, v8
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vmseq_vv_t12_m4_k1_vcpop_m_end
    __rvv_profile_marker_t30_vmseq_vv_t12_m4_k1_vcpop_m_end:
    .Lrvv_profile_marker_t30_vmseq_vv_t12_m4_k1_vcpop_m_end:

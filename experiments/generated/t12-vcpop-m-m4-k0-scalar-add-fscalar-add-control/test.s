...
# experiment_id: t12-vcpop-m-m4-k0-scalar-add-fscalar-add-control
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t12_vcpop_m_m4_k0_scalar_add_fscalar_add_control_start, end=__rvv_profile_marker_t12_vcpop_m_m4_k0_scalar_add_fscalar_add_control_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vcpop_m_m4_k0_scalar_add_fscalar_add_control_start
    __rvv_profile_marker_t12_vcpop_m_m4_k0_scalar_add_fscalar_add_control_start:
    .Lrvv_profile_marker_t12_vcpop_m_m4_k0_scalar_add_fscalar_add_control_start:
    vcpop.m x10, v0
    add x11, x28, x0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t12_vcpop_m_m4_k0_scalar_add_fscalar_add_control_end
    __rvv_profile_marker_t12_vcpop_m_m4_k0_scalar_add_fscalar_add_control_end:
    .Lrvv_profile_marker_t12_vcpop_m_m4_k0_scalar_add_fscalar_add_control_end:

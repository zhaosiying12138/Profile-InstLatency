...
# experiment_id: t12-viota-m-m4-k15-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t12_viota_m_m4_k15_vadd_vv_start, end=__rvv_profile_marker_t12_viota_m_m4_k15_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_viota_m_m4_k15_vadd_vv_start
    __rvv_profile_marker_t12_viota_m_m4_k15_vadd_vv_start:
    .Lrvv_profile_marker_t12_viota_m_m4_k15_vadd_vv_start:
    viota.m v8, v0
    ...
    .globl __rvv_profile_marker_t12_viota_m_m4_k15_vadd_vv_end
    __rvv_profile_marker_t12_viota_m_m4_k15_vadd_vv_end:
    .Lrvv_profile_marker_t12_viota_m_m4_k15_vadd_vv_end:

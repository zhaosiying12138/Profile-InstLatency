...
# experiment_id: t30-vrgather-vv-t12-m2-k40-vadd-vv
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vrgather_vv_t12_m2_k40_vadd_vv_start, end=__rvv_profile_marker_t30_vrgather_vv_t12_m2_k40_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vrgather_vv_t12_m2_k40_vadd_vv_start
    __rvv_profile_marker_t30_vrgather_vv_t12_m2_k40_vadd_vv_start:
    .Lrvv_profile_marker_t30_vrgather_vv_t12_m2_k40_vadd_vv_start:
    ...
    vadd.vv v16, v0, v2  # independent filler 32
    vadd.vv v18, v0, v2  # independent filler 33
    vadd.vv v20, v0, v2  # independent filler 34
    vadd.vv v22, v0, v2  # independent filler 35
    vadd.vv v24, v0, v2  # independent filler 36
    vadd.vv v26, v0, v2  # independent filler 37
    vadd.vv v28, v0, v2  # independent filler 38
    vadd.vv v30, v0, v2  # independent filler 39
    vadd.vv v6, v4, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vrgather_vv_t12_m2_k40_vadd_vv_end
    __rvv_profile_marker_t30_vrgather_vv_t12_m2_k40_vadd_vv_end:
    .Lrvv_profile_marker_t30_vrgather_vv_t12_m2_k40_vadd_vv_end:

# e05-vslideup_vx-m4-d28-ctrl [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vslideup_vx_m4_d28_ctrl_start
__yx_marker_e05_vslideup_vx_m4_d28_ctrl_start:
    vslideup.vx v8, v0, x6   # write1 -> v8
    ...
    vslideup.vx v12, v16, x6   # write2 -> v12
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vslideup_vx_m4_d28_ctrl_end
__yx_marker_e05_vslideup_vx_m4_d28_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

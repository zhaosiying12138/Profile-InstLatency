# e05-vmseq_vv-m1-d17-ctrl [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vmseq_vv_m1_d17_ctrl_start
__yx_marker_e05_vmseq_vv_m1_d17_ctrl_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vmseq_vv_m1_d17_ctrl_end
__yx_marker_e05_vmseq_vv_m1_d17_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

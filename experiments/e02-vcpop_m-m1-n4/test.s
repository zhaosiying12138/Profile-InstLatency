...
1:
    ...
    .globl __yx_marker_e02_vcpop_m_m1_n4_start
__yx_marker_e02_vcpop_m_m1_n4_start:
    vcpop.m x10, v0   # stream 0
    vcpop.m x10, v0   # stream 1
    vcpop.m x10, v0   # stream 2
    vcpop.m x10, v0   # stream 3
    # TIMESTAMP_MARK end
    .globl __yx_marker_e02_vcpop_m_m1_n4_end
__yx_marker_e02_vcpop_m_m1_n4_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

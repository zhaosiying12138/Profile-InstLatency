...
1:
    ...
    .globl __yx_marker_e10_loadhit_m4_k6_start
__yx_marker_e10_loadhit_m4_k6_start:
    vle32.v v8, (x8)   # measured load
    ...
    vadd.vv v12, v8, v0   # consumer
    # TIMESTAMP_MARK end
    .globl __yx_marker_e10_loadhit_m4_k6_end
__yx_marker_e10_loadhit_m4_k6_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

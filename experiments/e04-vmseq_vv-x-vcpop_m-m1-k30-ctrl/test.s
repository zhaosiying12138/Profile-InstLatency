# e04-vmseq_vv-x-vcpop_m-m1-k30-ctrl [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_vmseq_vv_x_vcpop_m_m1_k30_ctrl_start
__yx_marker_e04_vmseq_vv_x_vcpop_m_m1_k30_ctrl_start:
    vmseq.vv v2, v0, v1   # producer
    ...
    vcpop.m x11, 6   # mask consumer
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_vmseq_vv_x_vcpop_m_m1_k30_ctrl_end
__yx_marker_e04_vmseq_vv_x_vcpop_m_m1_k30_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

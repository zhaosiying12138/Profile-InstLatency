# e05-vslideup_vx-m4-d9-waw [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vslideup_vx_m4_d9_waw_start
__yx_marker_e05_vslideup_vx_m4_d9_waw_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vslideup_vx_m4_d9_waw_end
__yx_marker_e05_vslideup_vx_m4_d9_waw_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

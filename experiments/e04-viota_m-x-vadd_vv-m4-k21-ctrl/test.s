# e04-viota_m-x-vadd_vv-m4-k21-ctrl [E4_XRAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e04_viota_m_x_vadd_vv_m4_k21_ctrl_start
__yx_marker_e04_viota_m_x_vadd_vv_m4_k21_ctrl_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e04_viota_m_x_vadd_vv_m4_k21_ctrl_end
__yx_marker_e04_viota_m_x_vadd_vv_m4_k21_ctrl_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

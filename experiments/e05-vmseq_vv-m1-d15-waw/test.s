# e05-vmseq_vv-m1-d15-waw [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vmseq_vv_m1_d15_waw_start
__yx_marker_e05_vmseq_vv_m1_d15_waw_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vmseq_vv_m1_d15_waw_end
__yx_marker_e05_vmseq_vv_m1_d15_waw_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

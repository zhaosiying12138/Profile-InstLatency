# e05-vmseq_vv-m4-d12-waw [E5_WAW]
.text
.global _start
_start:
    # ---- setup ----
...
1:
    ...
    .globl __yx_marker_e05_vmseq_vv_m4_d12_waw_start
__yx_marker_e05_vmseq_vv_m4_d12_waw_start:
    ...
    # TIMESTAMP_MARK end
    .globl __yx_marker_e05_vmseq_vv_m4_d12_waw_end
__yx_marker_e05_vmseq_vv_m4_d12_waw_end:
    # ---- exit ----
    li a7, 93
    li a0, 0
    ecall

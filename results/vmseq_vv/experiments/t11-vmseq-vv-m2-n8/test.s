...
# experiment_id: t11-vmseq-vv-m2-n8
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t11_vmseq_vv_m2_n8_start, end=__rvv_profile_marker_t11_vmseq_vv_m2_n8_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vmseq_vv_m2_n8_start
    __rvv_profile_marker_t11_vmseq_vv_m2_n8_start:
    .Lrvv_profile_marker_t11_vmseq_vv_m2_n8_start:
    vmseq.vv v4, v0, v2
    vmseq.vv v4, v0, v2
    vmseq.vv v4, v0, v2
    vmseq.vv v4, v0, v2
    ...
    .globl __rvv_profile_marker_t11_vmseq_vv_m2_n8_end
    __rvv_profile_marker_t11_vmseq_vv_m2_n8_end:
    .Lrvv_profile_marker_t11_vmseq_vv_m2_n8_end:

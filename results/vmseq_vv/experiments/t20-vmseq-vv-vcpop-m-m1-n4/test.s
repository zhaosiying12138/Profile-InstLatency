...
# experiment_id: t20-vmseq-vv-vcpop-m-m1-n4
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vmseq_vv_vcpop_m_m1_n4_start, end=__rvv_profile_marker_t20_vmseq_vv_vcpop_m_m1_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_vcpop_m_m1_n4_start
    __rvv_profile_marker_t20_vmseq_vv_vcpop_m_m1_n4_start:
    .Lrvv_profile_marker_t20_vmseq_vv_vcpop_m_m1_n4_start:
    vmseq.vv v2, v0, v1
    vcpop.m x11, v0
    vmseq.vv v4, v0, v1
    vcpop.m x13, v0
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_vcpop_m_m1_n4_end
    __rvv_profile_marker_t20_vmseq_vv_vcpop_m_m1_n4_end:
    .Lrvv_profile_marker_t20_vmseq_vv_vcpop_m_m1_n4_end:

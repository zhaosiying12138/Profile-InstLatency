...
# experiment_id: t30-vmseq-vv-t12-m4-k24
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_vmseq_vv_t12_m4_k24_start, end=__rvv_profile_marker_t30_vmseq_vv_t12_m4_k24_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmseq_vv_t12_m4_k24_start
    __rvv_profile_marker_t30_vmseq_vv_t12_m4_k24_start:
    .Lrvv_profile_marker_t30_vmseq_vv_t12_m4_k24_start:
    vmseq.vv v8, v0, v4
    ...
    .globl __rvv_profile_marker_t30_vmseq_vv_t12_m4_k24_end
    __rvv_profile_marker_t30_vmseq_vv_t12_m4_k24_end:
    .Lrvv_profile_marker_t30_vmseq_vv_t12_m4_k24_end:

...
# experiment_id: t30-vmseq-vv-t12-m1-k35
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vmseq_vv_t12_m1_k35_start, end=__rvv_profile_marker_t30_vmseq_vv_t12_m1_k35_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmseq_vv_t12_m1_k35_start
    __rvv_profile_marker_t30_vmseq_vv_t12_m1_k35_start:
    .Lrvv_profile_marker_t30_vmseq_vv_t12_m1_k35_start:
    vmseq.vv v2, v0, v1
    ...
    .globl __rvv_profile_marker_t30_vmseq_vv_t12_m1_k35_end
    __rvv_profile_marker_t30_vmseq_vv_t12_m1_k35_end:
    .Lrvv_profile_marker_t30_vmseq_vv_t12_m1_k35_end:

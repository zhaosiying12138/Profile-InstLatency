...
# experiment_id: t21-vmseq-vv-m4-n4
# template_id: T21_PAIR_WITH_SCALAR
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t21_vmseq_vv_m4_n4_start, end=__rvv_profile_marker_t21_vmseq_vv_m4_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t21_vmseq_vv_m4_n4_start
    __rvv_profile_marker_t21_vmseq_vv_m4_n4_start:
    .Lrvv_profile_marker_t21_vmseq_vv_m4_n4_start:
    vmseq.vv v8, v0, v4
    add x20, x21, x22
    vmseq.vv v12, v0, v4
    add x23, x24, x25
    ...
    .globl __rvv_profile_marker_t21_vmseq_vv_m4_n4_end
    __rvv_profile_marker_t21_vmseq_vv_m4_n4_end:
    .Lrvv_profile_marker_t21_vmseq_vv_m4_n4_end:

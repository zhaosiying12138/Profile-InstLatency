...
# experiment_id: t20-vmseq-vv-viota-m-m2-n6
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vmseq_vv_viota_m_m2_n6_start, end=__rvv_profile_marker_t20_vmseq_vv_viota_m_m2_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_viota_m_m2_n6_start
    __rvv_profile_marker_t20_vmseq_vv_viota_m_m2_n6_start:
    .Lrvv_profile_marker_t20_vmseq_vv_viota_m_m2_n6_start:
    vmseq.vv v4, v0, v2
    viota.m v6, v0
    vmseq.vv v8, v0, v2
    viota.m v10, v0
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_viota_m_m2_n6_end
    __rvv_profile_marker_t20_vmseq_vv_viota_m_m2_n6_end:
    .Lrvv_profile_marker_t20_vmseq_vv_viota_m_m2_n6_end:

...
# experiment_id: t20-vmseq-vv-vredsum-vs-m1-n3
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m1_n3_start, end=__rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m1_n3_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m1_n3_start
    __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m1_n3_start:
    .Lrvv_profile_marker_t20_vmseq_vv_vredsum_vs_m1_n3_start:
    vmseq.vv v2, v0, v1
    vredsum.vs v3, v0, v1
    vmseq.vv v4, v0, v1
    vredsum.vs v5, v0, v1
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m1_n3_end
    __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m1_n3_end:
    .Lrvv_profile_marker_t20_vmseq_vv_vredsum_vs_m1_n3_end:

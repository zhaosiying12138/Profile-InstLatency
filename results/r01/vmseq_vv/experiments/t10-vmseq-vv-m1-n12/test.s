...
# experiment_id: t10-vmseq-vv-m1-n12
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t10_vmseq_vv_m1_n12_start, end=__rvv_profile_marker_t10_vmseq_vv_m1_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vmseq_vv_m1_n12_start
    __rvv_profile_marker_t10_vmseq_vv_m1_n12_start:
    .Lrvv_profile_marker_t10_vmseq_vv_m1_n12_start:
    vmseq.vv v2, v0, v1
    vmseq.vv v3, v0, v1
    vmseq.vv v4, v0, v1
    vmseq.vv v5, v0, v1
    ...
    .globl __rvv_profile_marker_t10_vmseq_vv_m1_n12_end
    __rvv_profile_marker_t10_vmseq_vv_m1_n12_end:
    .Lrvv_profile_marker_t10_vmseq_vv_m1_n12_end:

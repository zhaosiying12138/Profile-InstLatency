...
# experiment_id: t12-vmseq-vv-m2-k8-vcpop-m
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t12_vmseq_vv_m2_k8_vcpop_m_start, end=__rvv_profile_marker_t12_vmseq_vv_m2_k8_vcpop_m_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vmseq_vv_m2_k8_vcpop_m_start
    __rvv_profile_marker_t12_vmseq_vv_m2_k8_vcpop_m_start:
    .Lrvv_profile_marker_t12_vmseq_vv_m2_k8_vcpop_m_start:
    vmseq.vv v4, v0, v2
    ...
    .globl __rvv_profile_marker_t12_vmseq_vv_m2_k8_vcpop_m_end
    __rvv_profile_marker_t12_vmseq_vv_m2_k8_vcpop_m_end:
    .Lrvv_profile_marker_t12_vmseq_vv_m2_k8_vcpop_m_end:

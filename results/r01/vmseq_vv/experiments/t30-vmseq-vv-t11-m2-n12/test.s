...
# experiment_id: t30-vmseq-vv-t11-m2-n12
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vmseq_vv_t11_m2_n12_start, end=__rvv_profile_marker_t30_vmseq_vv_t11_m2_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmseq_vv_t11_m2_n12_start
    __rvv_profile_marker_t30_vmseq_vv_t11_m2_n12_start:
    .Lrvv_profile_marker_t30_vmseq_vv_t11_m2_n12_start:
    vmseq.vv v4, v0, v2
    vmseq.vv v4, v0, v2
    vmseq.vv v4, v0, v2
    vmseq.vv v4, v0, v2
    ...
    .globl __rvv_profile_marker_t30_vmseq_vv_t11_m2_n12_end
    __rvv_profile_marker_t30_vmseq_vv_t11_m2_n12_end:
    .Lrvv_profile_marker_t30_vmseq_vv_t11_m2_n12_end:

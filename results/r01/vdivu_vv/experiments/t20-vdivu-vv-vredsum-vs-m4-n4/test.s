...
# experiment_id: t20-vdivu-vv-vredsum-vs-m4-n4
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vdivu_vv_vredsum_vs_m4_n4_start, end=__rvv_profile_marker_t20_vdivu_vv_vredsum_vs_m4_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vdivu_vv_vredsum_vs_m4_n4_start
    __rvv_profile_marker_t20_vdivu_vv_vredsum_vs_m4_n4_start:
    .Lrvv_profile_marker_t20_vdivu_vv_vredsum_vs_m4_n4_start:
    vdivu.vv v8, v0, v4
    ...
    .globl __rvv_profile_marker_t20_vdivu_vv_vredsum_vs_m4_n4_end
    __rvv_profile_marker_t20_vdivu_vv_vredsum_vs_m4_n4_end:
    .Lrvv_profile_marker_t20_vdivu_vv_vredsum_vs_m4_n4_end:

...
# experiment_id: t20-vdivu-vv-vcpop-m-m4-n2
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vdivu_vv_vcpop_m_m4_n2_start, end=__rvv_profile_marker_t20_vdivu_vv_vcpop_m_m4_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vdivu_vv_vcpop_m_m4_n2_start
    __rvv_profile_marker_t20_vdivu_vv_vcpop_m_m4_n2_start:
    .Lrvv_profile_marker_t20_vdivu_vv_vcpop_m_m4_n2_start:
    vdivu.vv v8, v0, v4
    vcpop.m x10, v0
    vdivu.vv v12, v0, v4
    vcpop.m x11, v0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vdivu_vv_vcpop_m_m4_n2_end
    __rvv_profile_marker_t20_vdivu_vv_vcpop_m_m4_n2_end:
    .Lrvv_profile_marker_t20_vdivu_vv_vcpop_m_m4_n2_end:

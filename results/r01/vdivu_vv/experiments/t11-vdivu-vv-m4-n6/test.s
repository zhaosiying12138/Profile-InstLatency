...
# experiment_id: t11-vdivu-vv-m4-n6
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t11_vdivu_vv_m4_n6_start, end=__rvv_profile_marker_t11_vdivu_vv_m4_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vdivu_vv_m4_n6_start
    __rvv_profile_marker_t11_vdivu_vv_m4_n6_start:
    .Lrvv_profile_marker_t11_vdivu_vv_m4_n6_start:
    vdivu.vv v8, v0, v4
    vdivu.vv v8, v8, v4
    vdivu.vv v8, v8, v4
    vdivu.vv v8, v8, v4
    ...
    .globl __rvv_profile_marker_t11_vdivu_vv_m4_n6_end
    __rvv_profile_marker_t11_vdivu_vv_m4_n6_end:
    .Lrvv_profile_marker_t11_vdivu_vv_m4_n6_end:

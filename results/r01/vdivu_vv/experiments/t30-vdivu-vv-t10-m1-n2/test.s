...
# experiment_id: t30-vdivu-vv-t10-m1-n2
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vdivu_vv_t10_m1_n2_start, end=__rvv_profile_marker_t30_vdivu_vv_t10_m1_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vdivu_vv_t10_m1_n2_start
    __rvv_profile_marker_t30_vdivu_vv_t10_m1_n2_start:
    .Lrvv_profile_marker_t30_vdivu_vv_t10_m1_n2_start:
    vdivu.vv v2, v0, v1
    vdivu.vv v3, v0, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vdivu_vv_t10_m1_n2_end
    __rvv_profile_marker_t30_vdivu_vv_t10_m1_n2_end:
    .Lrvv_profile_marker_t30_vdivu_vv_t10_m1_n2_end:

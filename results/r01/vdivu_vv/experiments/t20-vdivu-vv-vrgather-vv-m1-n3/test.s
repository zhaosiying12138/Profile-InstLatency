...
# experiment_id: t20-vdivu-vv-vrgather-vv-m1-n3
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vdivu_vv_vrgather_vv_m1_n3_start, end=__rvv_profile_marker_t20_vdivu_vv_vrgather_vv_m1_n3_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vdivu_vv_vrgather_vv_m1_n3_start
    __rvv_profile_marker_t20_vdivu_vv_vrgather_vv_m1_n3_start:
    .Lrvv_profile_marker_t20_vdivu_vv_vrgather_vv_m1_n3_start:
    vdivu.vv v2, v0, v1
    ...
    .globl __rvv_profile_marker_t20_vdivu_vv_vrgather_vv_m1_n3_end
    __rvv_profile_marker_t20_vdivu_vv_vrgather_vv_m1_n3_end:
    .Lrvv_profile_marker_t20_vdivu_vv_vrgather_vv_m1_n3_end:

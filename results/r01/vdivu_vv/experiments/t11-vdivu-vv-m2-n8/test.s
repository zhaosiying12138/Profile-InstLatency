...
# experiment_id: t11-vdivu-vv-m2-n8
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t11_vdivu_vv_m2_n8_start, end=__rvv_profile_marker_t11_vdivu_vv_m2_n8_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vdivu_vv_m2_n8_start
    __rvv_profile_marker_t11_vdivu_vv_m2_n8_start:
    .Lrvv_profile_marker_t11_vdivu_vv_m2_n8_start:
    vdivu.vv v4, v0, v2
    vdivu.vv v4, v4, v2
    vdivu.vv v4, v4, v2
    vdivu.vv v4, v4, v2
    ...
    .globl __rvv_profile_marker_t11_vdivu_vv_m2_n8_end
    __rvv_profile_marker_t11_vdivu_vv_m2_n8_end:
    .Lrvv_profile_marker_t11_vdivu_vv_m2_n8_end:

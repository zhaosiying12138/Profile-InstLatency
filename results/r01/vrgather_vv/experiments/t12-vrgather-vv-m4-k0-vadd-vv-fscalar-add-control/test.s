...
# experiment_id: t12-vrgather-vv-m4-k0-vadd-vv-fscalar-add-control
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t12_vrgather_vv_m4_k0_vadd_vv_fscalar_add_control_start, end=__rvv_profile_marker_t12_vrgather_vv_m4_k0_vadd_vv_fscalar_add_control_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vrgather_vv_m4_k0_vadd_vv_fscalar_add_control_start
    __rvv_profile_marker_t12_vrgather_vv_m4_k0_vadd_vv_fscalar_add_control_start:
    .Lrvv_profile_marker_t12_vrgather_vv_m4_k0_vadd_vv_fscalar_add_control_start:
    vrgather.vv v8, v0, v4
    vadd.vv v12, v4, v0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t12_vrgather_vv_m4_k0_vadd_vv_fscalar_add_control_end
    __rvv_profile_marker_t12_vrgather_vv_m4_k0_vadd_vv_fscalar_add_control_end:
    .Lrvv_profile_marker_t12_vrgather_vv_m4_k0_vadd_vv_fscalar_add_control_end:

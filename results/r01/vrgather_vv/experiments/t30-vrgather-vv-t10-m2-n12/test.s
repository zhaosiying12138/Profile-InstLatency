...
# experiment_id: t30-vrgather-vv-t10-m2-n12
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vrgather_vv_t10_m2_n12_start, end=__rvv_profile_marker_t30_vrgather_vv_t10_m2_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vrgather_vv_t10_m2_n12_start
    __rvv_profile_marker_t30_vrgather_vv_t10_m2_n12_start:
    .Lrvv_profile_marker_t30_vrgather_vv_t10_m2_n12_start:
    vrgather.vv v4, v0, v2
    vrgather.vv v6, v0, v2
    vrgather.vv v8, v0, v2
    vrgather.vv v10, v0, v2
    vrgather.vv v12, v0, v2
    vrgather.vv v14, v0, v2
    vrgather.vv v16, v0, v2
    vrgather.vv v18, v0, v2
    vrgather.vv v20, v0, v2
    vrgather.vv v22, v0, v2
    vrgather.vv v24, v0, v2
    vrgather.vv v26, v0, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vrgather_vv_t10_m2_n12_end
    __rvv_profile_marker_t30_vrgather_vv_t10_m2_n12_end:
    .Lrvv_profile_marker_t30_vrgather_vv_t10_m2_n12_end:

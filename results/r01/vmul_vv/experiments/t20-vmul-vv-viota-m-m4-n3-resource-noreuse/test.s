...
# experiment_id: t20-vmul-vv-viota-m-m4-n3-resource-noreuse
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vmul_vv_viota_m_m4_n3_resource_noreuse_start, end=__rvv_profile_marker_t20_vmul_vv_viota_m_m4_n3_resource_noreuse_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmul_vv_viota_m_m4_n3_resource_noreuse_start
    __rvv_profile_marker_t20_vmul_vv_viota_m_m4_n3_resource_noreuse_start:
    .Lrvv_profile_marker_t20_vmul_vv_viota_m_m4_n3_resource_noreuse_start:
    vmul.vv v8, v0, v4
    viota.m v12, v0
    vmul.vv v16, v0, v4
    viota.m v20, v0
    ...
    .globl __rvv_profile_marker_t20_vmul_vv_viota_m_m4_n3_resource_noreuse_end
    __rvv_profile_marker_t20_vmul_vv_viota_m_m4_n3_resource_noreuse_end:
    .Lrvv_profile_marker_t20_vmul_vv_viota_m_m4_n3_resource_noreuse_end:

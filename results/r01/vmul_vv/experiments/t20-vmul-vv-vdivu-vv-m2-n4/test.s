...
# experiment_id: t20-vmul-vv-vdivu-vv-m2-n4
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vmul_vv_vdivu_vv_m2_n4_start, end=__rvv_profile_marker_t20_vmul_vv_vdivu_vv_m2_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmul_vv_vdivu_vv_m2_n4_start
    __rvv_profile_marker_t20_vmul_vv_vdivu_vv_m2_n4_start:
    .Lrvv_profile_marker_t20_vmul_vv_vdivu_vv_m2_n4_start:
    vmul.vv v4, v0, v2
    vdivu.vv v6, v0, v2
    vmul.vv v8, v0, v2
    vdivu.vv v10, v0, v2
    ...
    .globl __rvv_profile_marker_t20_vmul_vv_vdivu_vv_m2_n4_end
    __rvv_profile_marker_t20_vmul_vv_vdivu_vv_m2_n4_end:
    .Lrvv_profile_marker_t20_vmul_vv_vdivu_vv_m2_n4_end:

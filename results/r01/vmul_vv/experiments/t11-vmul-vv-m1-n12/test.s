...
# experiment_id: t11-vmul-vv-m1-n12
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t11_vmul_vv_m1_n12_start, end=__rvv_profile_marker_t11_vmul_vv_m1_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vmul_vv_m1_n12_start
    __rvv_profile_marker_t11_vmul_vv_m1_n12_start:
    .Lrvv_profile_marker_t11_vmul_vv_m1_n12_start:
    vmul.vv v2, v0, v1
    vmul.vv v2, v2, v1
    vmul.vv v2, v2, v1
    vmul.vv v2, v2, v1
    ...
    .globl __rvv_profile_marker_t11_vmul_vv_m1_n12_end
    __rvv_profile_marker_t11_vmul_vv_m1_n12_end:
    .Lrvv_profile_marker_t11_vmul_vv_m1_n12_end:

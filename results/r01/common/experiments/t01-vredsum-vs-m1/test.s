...
# experiment_id: t01-vredsum-vs-m1
# template_id: T01_DECODE_EXEC_KILLCHECK
# vector_shape: e32,m1
# markers: before=__rvv_profile_marker_t01_vredsum_vs_m1_before, after=__rvv_profile_marker_t01_vredsum_vs_m1_after, program_end=__rvv_profile_marker_t01_vredsum_vs_m1_program_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t01_vredsum_vs_m1_before
    __rvv_profile_marker_t01_vredsum_vs_m1_before:
    .Lrvv_profile_marker_t01_vredsum_vs_m1_before:
    vredsum.vs v2, v0, v1
    # marker after: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t01_vredsum_vs_m1_after
    __rvv_profile_marker_t01_vredsum_vs_m1_after:
    .Lrvv_profile_marker_t01_vredsum_vs_m1_after:
    # marker program_end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t01_vredsum_vs_m1_program_end
    __rvv_profile_marker_t01_vredsum_vs_m1_program_end:
    .Lrvv_profile_marker_t01_vredsum_vs_m1_program_end:

...
# experiment_id: t01-vmseq-vv-m4
# template_id: T01_DECODE_EXEC_KILLCHECK
# vector_shape: e32,m4
# markers: before=__rvv_profile_marker_t01_vmseq_vv_m4_before, after=__rvv_profile_marker_t01_vmseq_vv_m4_after, program_end=__rvv_profile_marker_t01_vmseq_vv_m4_program_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t01_vmseq_vv_m4_before
    __rvv_profile_marker_t01_vmseq_vv_m4_before:
    .Lrvv_profile_marker_t01_vmseq_vv_m4_before:
    vmseq.vv v8, v0, v4
    # marker after: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t01_vmseq_vv_m4_after
    __rvv_profile_marker_t01_vmseq_vv_m4_after:
    .Lrvv_profile_marker_t01_vmseq_vv_m4_after:
    # marker program_end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t01_vmseq_vv_m4_program_end
    __rvv_profile_marker_t01_vmseq_vv_m4_program_end:
    .Lrvv_profile_marker_t01_vmseq_vv_m4_program_end:

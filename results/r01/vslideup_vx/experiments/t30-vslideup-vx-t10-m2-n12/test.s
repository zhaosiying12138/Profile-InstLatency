...
# experiment_id: t30-vslideup-vx-t10-m2-n12
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vslideup_vx_t10_m2_n12_start, end=__rvv_profile_marker_t30_vslideup_vx_t10_m2_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vslideup_vx_t10_m2_n12_start
    __rvv_profile_marker_t30_vslideup_vx_t10_m2_n12_start:
    .Lrvv_profile_marker_t30_vslideup_vx_t10_m2_n12_start:
    ...
    vslideup.vx v18, v0, x6
    vslideup.vx v20, v0, x6
    vslideup.vx v22, v0, x6
    vslideup.vx v24, v0, x6
    vslideup.vx v26, v0, x6
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vslideup_vx_t10_m2_n12_end
    __rvv_profile_marker_t30_vslideup_vx_t10_m2_n12_end:
    .Lrvv_profile_marker_t30_vslideup_vx_t10_m2_n12_end:

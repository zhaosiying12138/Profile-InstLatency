...
# experiment_id: t12-vslideup-vx-m4-k0-vadd-vv-fscalar-add
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t12_vslideup_vx_m4_k0_vadd_vv_fscalar_add_start, end=__rvv_profile_marker_t12_vslideup_vx_m4_k0_vadd_vv_fscalar_add_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vslideup_vx_m4_k0_vadd_vv_fscalar_add_start
    __rvv_profile_marker_t12_vslideup_vx_m4_k0_vadd_vv_fscalar_add_start:
    .Lrvv_profile_marker_t12_vslideup_vx_m4_k0_vadd_vv_fscalar_add_start:
    vslideup.vx v8, v0, x6
    vadd.vv v12, v8, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t12_vslideup_vx_m4_k0_vadd_vv_fscalar_add_end
    __rvv_profile_marker_t12_vslideup_vx_m4_k0_vadd_vv_fscalar_add_end:
    .Lrvv_profile_marker_t12_vslideup_vx_m4_k0_vadd_vv_fscalar_add_end:

...
# experiment_id: t30-viota-m-t10-m4-n2
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_viota_m_t10_m4_n2_start, end=__rvv_profile_marker_t30_viota_m_t10_m4_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_viota_m_t10_m4_n2_start
    __rvv_profile_marker_t30_viota_m_t10_m4_n2_start:
    .Lrvv_profile_marker_t30_viota_m_t10_m4_n2_start:
    viota.m v8, v0
    viota.m v12, v0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_viota_m_t10_m4_n2_end
    __rvv_profile_marker_t30_viota_m_t10_m4_n2_end:
    .Lrvv_profile_marker_t30_viota_m_t10_m4_n2_end:

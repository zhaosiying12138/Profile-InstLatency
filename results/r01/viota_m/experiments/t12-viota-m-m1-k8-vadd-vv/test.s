...
# experiment_id: t12-viota-m-m1-k8-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t12_viota_m_m1_k8_vadd_vv_start, end=__rvv_profile_marker_t12_viota_m_m1_k8_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_viota_m_m1_k8_vadd_vv_start
    __rvv_profile_marker_t12_viota_m_m1_k8_vadd_vv_start:
    .Lrvv_profile_marker_t12_viota_m_m1_k8_vadd_vv_start:
    viota.m v2, v0
    ...
    .globl __rvv_profile_marker_t12_viota_m_m1_k8_vadd_vv_end
    __rvv_profile_marker_t12_viota_m_m1_k8_vadd_vv_end:
    .Lrvv_profile_marker_t12_viota_m_m1_k8_vadd_vv_end:

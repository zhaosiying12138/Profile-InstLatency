...
# experiment_id: t10-viota-m-m2-n2
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t10_viota_m_m2_n2_start, end=__rvv_profile_marker_t10_viota_m_m2_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_viota_m_m2_n2_start
    __rvv_profile_marker_t10_viota_m_m2_n2_start:
    .Lrvv_profile_marker_t10_viota_m_m2_n2_start:
    viota.m v4, v0
    viota.m v6, v0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t10_viota_m_m2_n2_end
    __rvv_profile_marker_t10_viota_m_m2_n2_end:
    .Lrvv_profile_marker_t10_viota_m_m2_n2_end:

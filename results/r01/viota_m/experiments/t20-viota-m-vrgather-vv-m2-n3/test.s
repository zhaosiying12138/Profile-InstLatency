...
# experiment_id: t20-viota-m-vrgather-vv-m2-n3
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_viota_m_vrgather_vv_m2_n3_start, end=__rvv_profile_marker_t20_viota_m_vrgather_vv_m2_n3_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_viota_m_vrgather_vv_m2_n3_start
    __rvv_profile_marker_t20_viota_m_vrgather_vv_m2_n3_start:
    .Lrvv_profile_marker_t20_viota_m_vrgather_vv_m2_n3_start:
    viota.m v4, v0
    ...
    .globl __rvv_profile_marker_t20_viota_m_vrgather_vv_m2_n3_end
    __rvv_profile_marker_t20_viota_m_vrgather_vv_m2_n3_end:
    .Lrvv_profile_marker_t20_viota_m_vrgather_vv_m2_n3_end:

...
# experiment_id: t12-vcpop-m-m2-k0-scalar-add
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t12_vcpop_m_m2_k0_scalar_add_start, end=__rvv_profile_marker_t12_vcpop_m_m2_k0_scalar_add_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vcpop_m_m2_k0_scalar_add_start
    __rvv_profile_marker_t12_vcpop_m_m2_k0_scalar_add_start:
    .Lrvv_profile_marker_t12_vcpop_m_m2_k0_scalar_add_start:
    vcpop.m x10, v0
    add x11, x10, x0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t12_vcpop_m_m2_k0_scalar_add_end
    __rvv_profile_marker_t12_vcpop_m_m2_k0_scalar_add_end:
    .Lrvv_profile_marker_t12_vcpop_m_m2_k0_scalar_add_end:

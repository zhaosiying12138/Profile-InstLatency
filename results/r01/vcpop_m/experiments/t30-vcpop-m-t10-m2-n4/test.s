...
# experiment_id: t30-vcpop-m-t10-m2-n4
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vcpop_m_t10_m2_n4_start, end=__rvv_profile_marker_t30_vcpop_m_t10_m2_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vcpop_m_t10_m2_n4_start
    __rvv_profile_marker_t30_vcpop_m_t10_m2_n4_start:
    .Lrvv_profile_marker_t30_vcpop_m_t10_m2_n4_start:
    vcpop.m x10, v0
    vcpop.m x11, v0
    vcpop.m x12, v0
    vcpop.m x13, v0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vcpop_m_t10_m2_n4_end
    __rvv_profile_marker_t30_vcpop_m_t10_m2_n4_end:
    .Lrvv_profile_marker_t30_vcpop_m_t10_m2_n4_end:

...
# experiment_id: t11-vcpop-m-m4-n8
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t11_vcpop_m_m4_n8_start, end=__rvv_profile_marker_t11_vcpop_m_m4_n8_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vcpop_m_m4_n8_start
    __rvv_profile_marker_t11_vcpop_m_m4_n8_start:
    .Lrvv_profile_marker_t11_vcpop_m_m4_n8_start:
    vcpop.m x10, v0
    vcpop.m x10, v0
    vcpop.m x10, v0
    vcpop.m x10, v0
    ...
    .globl __rvv_profile_marker_t11_vcpop_m_m4_n8_end
    __rvv_profile_marker_t11_vcpop_m_m4_n8_end:
    .Lrvv_profile_marker_t11_vcpop_m_m4_n8_end:

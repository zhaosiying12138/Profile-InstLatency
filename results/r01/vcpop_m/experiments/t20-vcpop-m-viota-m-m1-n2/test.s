...
# experiment_id: t20-vcpop-m-viota-m-m1-n2
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vcpop_m_viota_m_m1_n2_start, end=__rvv_profile_marker_t20_vcpop_m_viota_m_m1_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vcpop_m_viota_m_m1_n2_start
    __rvv_profile_marker_t20_vcpop_m_viota_m_m1_n2_start:
    .Lrvv_profile_marker_t20_vcpop_m_viota_m_m1_n2_start:
    vcpop.m x10, v0
    viota.m v2, v0
    vcpop.m x11, v0
    viota.m v3, v0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vcpop_m_viota_m_m1_n2_end
    __rvv_profile_marker_t20_vcpop_m_viota_m_m1_n2_end:
    .Lrvv_profile_marker_t20_vcpop_m_viota_m_m1_n2_end:

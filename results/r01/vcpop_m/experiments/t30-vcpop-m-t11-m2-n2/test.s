...
# experiment_id: t30-vcpop-m-t11-m2-n2
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vcpop_m_t11_m2_n2_start, end=__rvv_profile_marker_t30_vcpop_m_t11_m2_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vcpop_m_t11_m2_n2_start
    __rvv_profile_marker_t30_vcpop_m_t11_m2_n2_start:
    .Lrvv_profile_marker_t30_vcpop_m_t11_m2_n2_start:
    vcpop.m x10, v0
    vcpop.m x10, v0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vcpop_m_t11_m2_n2_end
    __rvv_profile_marker_t30_vcpop_m_t11_m2_n2_end:
    .Lrvv_profile_marker_t30_vcpop_m_t11_m2_n2_end:

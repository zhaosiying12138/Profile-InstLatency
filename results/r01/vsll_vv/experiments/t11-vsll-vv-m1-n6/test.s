...
# experiment_id: t11-vsll-vv-m1-n6
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t11_vsll_vv_m1_n6_start, end=__rvv_profile_marker_t11_vsll_vv_m1_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vsll_vv_m1_n6_start
    __rvv_profile_marker_t11_vsll_vv_m1_n6_start:
    .Lrvv_profile_marker_t11_vsll_vv_m1_n6_start:
    vsll.vv v2, v0, v1
    vsll.vv v2, v2, v1
    vsll.vv v2, v2, v1
    vsll.vv v2, v2, v1
    ...
    .globl __rvv_profile_marker_t11_vsll_vv_m1_n6_end
    __rvv_profile_marker_t11_vsll_vv_m1_n6_end:
    .Lrvv_profile_marker_t11_vsll_vv_m1_n6_end:

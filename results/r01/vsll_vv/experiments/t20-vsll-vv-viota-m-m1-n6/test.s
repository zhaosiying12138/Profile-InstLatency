...
# experiment_id: t20-vsll-vv-viota-m-m1-n6
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vsll_vv_viota_m_m1_n6_start, end=__rvv_profile_marker_t20_vsll_vv_viota_m_m1_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vsll_vv_viota_m_m1_n6_start
    __rvv_profile_marker_t20_vsll_vv_viota_m_m1_n6_start:
    .Lrvv_profile_marker_t20_vsll_vv_viota_m_m1_n6_start:
    vsll.vv v2, v0, v1
    viota.m v3, v0
    vsll.vv v4, v0, v1
    viota.m v5, v0
    ...
    .globl __rvv_profile_marker_t20_vsll_vv_viota_m_m1_n6_end
    __rvv_profile_marker_t20_vsll_vv_viota_m_m1_n6_end:
    .Lrvv_profile_marker_t20_vsll_vv_viota_m_m1_n6_end:

...
# experiment_id: t12-vsll-vv-m1-k16-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t12_vsll_vv_m1_k16_vadd_vv_start, end=__rvv_profile_marker_t12_vsll_vv_m1_k16_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vsll_vv_m1_k16_vadd_vv_start
    __rvv_profile_marker_t12_vsll_vv_m1_k16_vadd_vv_start:
    .Lrvv_profile_marker_t12_vsll_vv_m1_k16_vadd_vv_start:
    vsll.vv v2, v0, v1
    ...
    .globl __rvv_profile_marker_t12_vsll_vv_m1_k16_vadd_vv_end
    __rvv_profile_marker_t12_vsll_vv_m1_k16_vadd_vv_end:
    .Lrvv_profile_marker_t12_vsll_vv_m1_k16_vadd_vv_end:

...
# experiment_id: t30-vadd-vv-t10-m1-n12
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vadd_vv_t10_m1_n12_start, end=__rvv_profile_marker_t30_vadd_vv_t10_m1_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t10_m1_n12_start
    __rvv_profile_marker_t30_vadd_vv_t10_m1_n12_start:
    .Lrvv_profile_marker_t30_vadd_vv_t10_m1_n12_start:
    vadd.vv v2, v0, v1
    vadd.vv v3, v0, v1
    vadd.vv v4, v0, v1
    vadd.vv v5, v0, v1
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t10_m1_n12_end
    __rvv_profile_marker_t30_vadd_vv_t10_m1_n12_end:
    .Lrvv_profile_marker_t30_vadd_vv_t10_m1_n12_end:

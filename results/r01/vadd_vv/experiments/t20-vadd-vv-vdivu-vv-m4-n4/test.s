...
# experiment_id: t20-vadd-vv-vdivu-vv-m4-n4
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n4_start, end=__rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n4_start
    __rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n4_start:
    .Lrvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n4_start:
    vadd.vv v8, v0, v4
    vdivu.vv v12, v0, v4
    vadd.vv v16, v0, v4
    vdivu.vv v20, v0, v4
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n4_end
    __rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n4_end:
    .Lrvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n4_end:

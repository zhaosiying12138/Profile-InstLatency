...
# experiment_id: t20-vadd-vv-vslideup-vx-m4-n3
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vadd_vv_vslideup_vx_m4_n3_start, end=__rvv_profile_marker_t20_vadd_vv_vslideup_vx_m4_n3_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vslideup_vx_m4_n3_start
    __rvv_profile_marker_t20_vadd_vv_vslideup_vx_m4_n3_start:
    .Lrvv_profile_marker_t20_vadd_vv_vslideup_vx_m4_n3_start:
    vadd.vv v8, v0, v4
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vslideup_vx_m4_n3_end
    __rvv_profile_marker_t20_vadd_vv_vslideup_vx_m4_n3_end:
    .Lrvv_profile_marker_t20_vadd_vv_vslideup_vx_m4_n3_end:

...
# experiment_id: t20-vadd-vv-vmul-vv-m1-n4
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vadd_vv_vmul_vv_m1_n4_start, end=__rvv_profile_marker_t20_vadd_vv_vmul_vv_m1_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vmul_vv_m1_n4_start
    __rvv_profile_marker_t20_vadd_vv_vmul_vv_m1_n4_start:
    .Lrvv_profile_marker_t20_vadd_vv_vmul_vv_m1_n4_start:
    vadd.vv v2, v0, v1
    vmul.vv v3, v0, v1
    vadd.vv v4, v0, v1
    vmul.vv v5, v0, v1
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vmul_vv_m1_n4_end
    __rvv_profile_marker_t20_vadd_vv_vmul_vv_m1_n4_end:
    .Lrvv_profile_marker_t20_vadd_vv_vmul_vv_m1_n4_end:

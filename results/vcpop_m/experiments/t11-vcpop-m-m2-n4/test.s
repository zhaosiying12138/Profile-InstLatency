...
# experiment_id: t11-vcpop-m-m2-n4
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t11_vcpop_m_m2_n4_start, end=__rvv_profile_marker_t11_vcpop_m_m2_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vcpop_m_m2_n4_start
    __rvv_profile_marker_t11_vcpop_m_m2_n4_start:
    .Lrvv_profile_marker_t11_vcpop_m_m2_n4_start:
    vcpop.m x10, v0
    vcpop.m x10, v0
    vcpop.m x10, v0
    vcpop.m x10, v0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t11_vcpop_m_m2_n4_end
    __rvv_profile_marker_t11_vcpop_m_m2_n4_end:
    .Lrvv_profile_marker_t11_vcpop_m_m2_n4_end:

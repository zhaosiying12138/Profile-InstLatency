...
# experiment_id: t30-vmul-vv-t12-m2-k2
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vmul_vv_t12_m2_k2_start, end=__rvv_profile_marker_t30_vmul_vv_t12_m2_k2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t12_m2_k2_start
    __rvv_profile_marker_t30_vmul_vv_t12_m2_k2_start:
    .Lrvv_profile_marker_t30_vmul_vv_t12_m2_k2_start:
    vmul.vv v4, v0, v2
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t12_m2_k2_end
    __rvv_profile_marker_t30_vmul_vv_t12_m2_k2_end:
    .Lrvv_profile_marker_t30_vmul_vv_t12_m2_k2_end:

...
# experiment_id: t30-vmul-vv-t12-m4-k2
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_vmul_vv_t12_m4_k2_start, end=__rvv_profile_marker_t30_vmul_vv_t12_m4_k2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t12_m4_k2_start
    __rvv_profile_marker_t30_vmul_vv_t12_m4_k2_start:
    .Lrvv_profile_marker_t30_vmul_vv_t12_m4_k2_start:
    vmul.vv v8, v0, v4
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t12_m4_k2_end
    __rvv_profile_marker_t30_vmul_vv_t12_m4_k2_end:
    .Lrvv_profile_marker_t30_vmul_vv_t12_m4_k2_end:

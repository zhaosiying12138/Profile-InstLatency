...
# experiment_id: t30-vrgather-vv-t10-m1-n12
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vrgather_vv_t10_m1_n12_start, end=__rvv_profile_marker_t30_vrgather_vv_t10_m1_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vrgather_vv_t10_m1_n12_start
    __rvv_profile_marker_t30_vrgather_vv_t10_m1_n12_start:
    .Lrvv_profile_marker_t30_vrgather_vv_t10_m1_n12_start:
    vrgather.vv v2, v0, v1
    vrgather.vv v3, v0, v1
    vrgather.vv v4, v0, v1
    vrgather.vv v5, v0, v1
    vrgather.vv v6, v0, v1
    vrgather.vv v7, v0, v1
    vrgather.vv v8, v0, v1
    vrgather.vv v9, v0, v1
    vrgather.vv v10, v0, v1
    vrgather.vv v11, v0, v1
    vrgather.vv v12, v0, v1
    vrgather.vv v13, v0, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vrgather_vv_t10_m1_n12_end
    __rvv_profile_marker_t30_vrgather_vv_t10_m1_n12_end:
    .Lrvv_profile_marker_t30_vrgather_vv_t10_m1_n12_end:

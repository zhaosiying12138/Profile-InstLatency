...
# experiment_id: t11-vrgather-vv-m2-n2
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t11_vrgather_vv_m2_n2_start, end=__rvv_profile_marker_t11_vrgather_vv_m2_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vrgather_vv_m2_n2_start
    __rvv_profile_marker_t11_vrgather_vv_m2_n2_start:
    .Lrvv_profile_marker_t11_vrgather_vv_m2_n2_start:
    vrgather.vv v4, v0, v2
    vrgather.vv v4, v0, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t11_vrgather_vv_m2_n2_end
    __rvv_profile_marker_t11_vrgather_vv_m2_n2_end:
    .Lrvv_profile_marker_t11_vrgather_vv_m2_n2_end:

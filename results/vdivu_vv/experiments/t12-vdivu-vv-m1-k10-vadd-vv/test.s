...
# experiment_id: t12-vdivu-vv-m1-k10-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t12_vdivu_vv_m1_k10_vadd_vv_start, end=__rvv_profile_marker_t12_vdivu_vv_m1_k10_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vdivu_vv_m1_k10_vadd_vv_start
    __rvv_profile_marker_t12_vdivu_vv_m1_k10_vadd_vv_start:
    .Lrvv_profile_marker_t12_vdivu_vv_m1_k10_vadd_vv_start:
    vdivu.vv v2, v0, v1
    ...
    .globl __rvv_profile_marker_t12_vdivu_vv_m1_k10_vadd_vv_end
    __rvv_profile_marker_t12_vdivu_vv_m1_k10_vadd_vv_end:
    .Lrvv_profile_marker_t12_vdivu_vv_m1_k10_vadd_vv_end:

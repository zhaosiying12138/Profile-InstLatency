...
# experiment_id: t10-vdivu-vv-m2-n8
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t10_vdivu_vv_m2_n8_start, end=__rvv_profile_marker_t10_vdivu_vv_m2_n8_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vdivu_vv_m2_n8_start
    __rvv_profile_marker_t10_vdivu_vv_m2_n8_start:
    .Lrvv_profile_marker_t10_vdivu_vv_m2_n8_start:
    vdivu.vv v4, v0, v2
    vdivu.vv v6, v0, v2
    vdivu.vv v8, v0, v2
    vdivu.vv v10, v0, v2
    ...
    .globl __rvv_profile_marker_t10_vdivu_vv_m2_n8_end
    __rvv_profile_marker_t10_vdivu_vv_m2_n8_end:
    .Lrvv_profile_marker_t10_vdivu_vv_m2_n8_end:

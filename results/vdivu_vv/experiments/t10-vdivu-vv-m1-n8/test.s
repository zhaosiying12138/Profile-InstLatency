...
# experiment_id: t10-vdivu-vv-m1-n8
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t10_vdivu_vv_m1_n8_start, end=__rvv_profile_marker_t10_vdivu_vv_m1_n8_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vdivu_vv_m1_n8_start
    __rvv_profile_marker_t10_vdivu_vv_m1_n8_start:
    .Lrvv_profile_marker_t10_vdivu_vv_m1_n8_start:
    vdivu.vv v2, v0, v1
    vdivu.vv v3, v0, v1
    vdivu.vv v4, v0, v1
    vdivu.vv v5, v0, v1
    ...
    .globl __rvv_profile_marker_t10_vdivu_vv_m1_n8_end
    __rvv_profile_marker_t10_vdivu_vv_m1_n8_end:
    .Lrvv_profile_marker_t10_vdivu_vv_m1_n8_end:

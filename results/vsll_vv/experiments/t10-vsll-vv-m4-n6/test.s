...
# experiment_id: t10-vsll-vv-m4-n6
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t10_vsll_vv_m4_n6_start, end=__rvv_profile_marker_t10_vsll_vv_m4_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vsll_vv_m4_n6_start
    __rvv_profile_marker_t10_vsll_vv_m4_n6_start:
    .Lrvv_profile_marker_t10_vsll_vv_m4_n6_start:
    vsll.vv v8, v0, v4
    vsll.vv v12, v0, v4
    vsll.vv v16, v0, v4
    vsll.vv v20, v0, v4
    ...
    .globl __rvv_profile_marker_t10_vsll_vv_m4_n6_end
    __rvv_profile_marker_t10_vsll_vv_m4_n6_end:
    .Lrvv_profile_marker_t10_vsll_vv_m4_n6_end:

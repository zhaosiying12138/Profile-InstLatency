...
# experiment_id: t30-vsll-vv-t12-m2-k32
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vsll_vv_t12_m2_k32_start, end=__rvv_profile_marker_t30_vsll_vv_t12_m2_k32_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vsll_vv_t12_m2_k32_start
    __rvv_profile_marker_t30_vsll_vv_t12_m2_k32_start:
    .Lrvv_profile_marker_t30_vsll_vv_t12_m2_k32_start:
    vsll.vv v4, v0, v2
    ...
    .globl __rvv_profile_marker_t30_vsll_vv_t12_m2_k32_end
    __rvv_profile_marker_t30_vsll_vv_t12_m2_k32_end:
    .Lrvv_profile_marker_t30_vsll_vv_t12_m2_k32_end:

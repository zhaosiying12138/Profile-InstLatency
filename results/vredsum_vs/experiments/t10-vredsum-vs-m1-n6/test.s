...
# experiment_id: t10-vredsum-vs-m1-n6
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t10_vredsum_vs_m1_n6_start, end=__rvv_profile_marker_t10_vredsum_vs_m1_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vredsum_vs_m1_n6_start
    __rvv_profile_marker_t10_vredsum_vs_m1_n6_start:
    .Lrvv_profile_marker_t10_vredsum_vs_m1_n6_start:
    vredsum.vs v2, v0, v1
    vredsum.vs v3, v0, v1
    vredsum.vs v4, v0, v1
    vredsum.vs v5, v0, v1
    ...
    .globl __rvv_profile_marker_t10_vredsum_vs_m1_n6_end
    __rvv_profile_marker_t10_vredsum_vs_m1_n6_end:
    .Lrvv_profile_marker_t10_vredsum_vs_m1_n6_end:

...
# experiment_id: t10-vredsum-vs-m2-n6
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t10_vredsum_vs_m2_n6_start, end=__rvv_profile_marker_t10_vredsum_vs_m2_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vredsum_vs_m2_n6_start
    __rvv_profile_marker_t10_vredsum_vs_m2_n6_start:
    .Lrvv_profile_marker_t10_vredsum_vs_m2_n6_start:
    vredsum.vs v4, v0, v2
    vredsum.vs v6, v0, v2
    vredsum.vs v8, v0, v2
    ...
    .globl __rvv_profile_marker_t10_vredsum_vs_m2_n6_end
    __rvv_profile_marker_t10_vredsum_vs_m2_n6_end:
    .Lrvv_profile_marker_t10_vredsum_vs_m2_n6_end:

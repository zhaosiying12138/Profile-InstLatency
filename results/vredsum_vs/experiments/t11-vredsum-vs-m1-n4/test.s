...
# experiment_id: t11-vredsum-vs-m1-n4
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t11_vredsum_vs_m1_n4_start, end=__rvv_profile_marker_t11_vredsum_vs_m1_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vredsum_vs_m1_n4_start
    __rvv_profile_marker_t11_vredsum_vs_m1_n4_start:
    .Lrvv_profile_marker_t11_vredsum_vs_m1_n4_start:
    vredsum.vs v2, v0, v1
    vredsum.vs v2, v2, v1
    vredsum.vs v2, v2, v1
    vredsum.vs v2, v2, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t11_vredsum_vs_m1_n4_end
    __rvv_profile_marker_t11_vredsum_vs_m1_n4_end:
    .Lrvv_profile_marker_t11_vredsum_vs_m1_n4_end:

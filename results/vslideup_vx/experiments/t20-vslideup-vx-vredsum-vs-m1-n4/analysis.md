...
For synthetic calibration, configured latency, release, and pipe come from `t20-vslideup-vx-vredsum-vs-m1-n4` at `results/vslideup_vx/experiments/t20-vslideup-vx-vredsum-vs-m1-n4/trace.json`.

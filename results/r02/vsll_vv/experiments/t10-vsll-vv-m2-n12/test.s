...
# experiment_id: t10-vsll-vv-m2-n12
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t10_vsll_vv_m2_n12_start, end=__rvv_profile_marker_t10_vsll_vv_m2_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vsll_vv_m2_n12_start
    __rvv_profile_marker_t10_vsll_vv_m2_n12_start:
    .Lrvv_profile_marker_t10_vsll_vv_m2_n12_start:
    vsll.vv v4, v0, v2
    vsll.vv v6, v0, v2
    vsll.vv v8, v0, v2
    vsll.vv v10, v0, v2
    ...
    .globl __rvv_profile_marker_t10_vsll_vv_m2_n12_end
    __rvv_profile_marker_t10_vsll_vv_m2_n12_end:
    .Lrvv_profile_marker_t10_vsll_vv_m2_n12_end:

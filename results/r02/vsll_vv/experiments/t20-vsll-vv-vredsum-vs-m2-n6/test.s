...
# experiment_id: t20-vsll-vv-vredsum-vs-m2-n6
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vsll_vv_vredsum_vs_m2_n6_start, end=__rvv_profile_marker_t20_vsll_vv_vredsum_vs_m2_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vsll_vv_vredsum_vs_m2_n6_start
    __rvv_profile_marker_t20_vsll_vv_vredsum_vs_m2_n6_start:
    .Lrvv_profile_marker_t20_vsll_vv_vredsum_vs_m2_n6_start:
    vsll.vv v4, v0, v2
    vredsum.vs v6, v0, v2
    vsll.vv v8, v0, v2
    ...
    .globl __rvv_profile_marker_t20_vsll_vv_vredsum_vs_m2_n6_end
    __rvv_profile_marker_t20_vsll_vv_vredsum_vs_m2_n6_end:
    .Lrvv_profile_marker_t20_vsll_vv_vredsum_vs_m2_n6_end:

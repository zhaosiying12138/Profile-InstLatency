...
# experiment_id: t30-vsll-vv-t12-m2-k1
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vsll_vv_t12_m2_k1_start, end=__rvv_profile_marker_t30_vsll_vv_t12_m2_k1_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vsll_vv_t12_m2_k1_start
    __rvv_profile_marker_t30_vsll_vv_t12_m2_k1_start:
    .Lrvv_profile_marker_t30_vsll_vv_t12_m2_k1_start:
    vsll.vv v4, v0, v2
    vadd.vv v8, v0, v2  # independent filler 0
    vadd.vv v6, v4, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vsll_vv_t12_m2_k1_end
    __rvv_profile_marker_t30_vsll_vv_t12_m2_k1_end:
    .Lrvv_profile_marker_t30_vsll_vv_t12_m2_k1_end:

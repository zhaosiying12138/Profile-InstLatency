...
# experiment_id: t11-vmseq-vv-m4-n2
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t11_vmseq_vv_m4_n2_start, end=__rvv_profile_marker_t11_vmseq_vv_m4_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vmseq_vv_m4_n2_start
    __rvv_profile_marker_t11_vmseq_vv_m4_n2_start:
    .Lrvv_profile_marker_t11_vmseq_vv_m4_n2_start:
    vmseq.vv v8, v0, v4
    vmseq.vv v8, v0, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t11_vmseq_vv_m4_n2_end
    __rvv_profile_marker_t11_vmseq_vv_m4_n2_end:
    .Lrvv_profile_marker_t11_vmseq_vv_m4_n2_end:

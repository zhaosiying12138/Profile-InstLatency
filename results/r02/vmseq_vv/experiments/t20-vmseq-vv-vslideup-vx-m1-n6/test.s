...
# experiment_id: t20-vmseq-vv-vslideup-vx-m1-n6
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vmseq_vv_vslideup_vx_m1_n6_start, end=__rvv_profile_marker_t20_vmseq_vv_vslideup_vx_m1_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_vslideup_vx_m1_n6_start
    __rvv_profile_marker_t20_vmseq_vv_vslideup_vx_m1_n6_start:
    .Lrvv_profile_marker_t20_vmseq_vv_vslideup_vx_m1_n6_start:
    vmseq.vv v2, v0, v1
    ...
    vmseq.vv v10, v0, v1
    vslideup.vx v11, v0, x6
    vmseq.vv v12, v0, v1
    vslideup.vx v13, v0, x6
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vmseq_vv_vslideup_vx_m1_n6_end
    __rvv_profile_marker_t20_vmseq_vv_vslideup_vx_m1_n6_end:
    .Lrvv_profile_marker_t20_vmseq_vv_vslideup_vx_m1_n6_end:

...
# experiment_id: t20-vmseq-vv-viota-m-m4-n4
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vmseq_vv_viota_m_m4_n4_start, end=__rvv_profile_marker_t20_vmseq_vv_viota_m_m4_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_viota_m_m4_n4_start
    __rvv_profile_marker_t20_vmseq_vv_viota_m_m4_n4_start:
    .Lrvv_profile_marker_t20_vmseq_vv_viota_m_m4_n4_start:
    vmseq.vv v8, v0, v4
    viota.m v12, v0
    vmseq.vv v16, v0, v4
    viota.m v20, v0
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_viota_m_m4_n4_end
    __rvv_profile_marker_t20_vmseq_vv_viota_m_m4_n4_end:
    .Lrvv_profile_marker_t20_vmseq_vv_viota_m_m4_n4_end:

...
# experiment_id: t30-vmseq-vv-t10-m4-n4
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_vmseq_vv_t10_m4_n4_start, end=__rvv_profile_marker_t30_vmseq_vv_t10_m4_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmseq_vv_t10_m4_n4_start
    __rvv_profile_marker_t30_vmseq_vv_t10_m4_n4_start:
    .Lrvv_profile_marker_t30_vmseq_vv_t10_m4_n4_start:
    vmseq.vv v8, v0, v4
    vmseq.vv v12, v0, v4
    vmseq.vv v16, v0, v4
    vmseq.vv v20, v0, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vmseq_vv_t10_m4_n4_end
    __rvv_profile_marker_t30_vmseq_vv_t10_m4_n4_end:
    .Lrvv_profile_marker_t30_vmseq_vv_t10_m4_n4_end:

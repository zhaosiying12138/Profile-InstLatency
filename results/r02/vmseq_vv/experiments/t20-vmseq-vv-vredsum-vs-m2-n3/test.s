...
# experiment_id: t20-vmseq-vv-vredsum-vs-m2-n3
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m2_n3_start, end=__rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m2_n3_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m2_n3_start
    __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m2_n3_start:
    .Lrvv_profile_marker_t20_vmseq_vv_vredsum_vs_m2_n3_start:
    vmseq.vv v4, v0, v2
    vredsum.vs v6, v0, v2
    vmseq.vv v8, v0, v2
    ...
    .globl __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m2_n3_end
    __rvv_profile_marker_t20_vmseq_vv_vredsum_vs_m2_n3_end:
    .Lrvv_profile_marker_t20_vmseq_vv_vredsum_vs_m2_n3_end:

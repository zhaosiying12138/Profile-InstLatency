...
# experiment_id: t10-vcpop-m-m4-scalar-fixed-n2
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t10_vcpop_m_m4_scalar_fixed_n2_start, end=__rvv_profile_marker_t10_vcpop_m_m4_scalar_fixed_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vcpop_m_m4_scalar_fixed_n2_start
    __rvv_profile_marker_t10_vcpop_m_m4_scalar_fixed_n2_start:
    .Lrvv_profile_marker_t10_vcpop_m_m4_scalar_fixed_n2_start:
    vcpop.m x10, v0
    vcpop.m x10, v0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t10_vcpop_m_m4_scalar_fixed_n2_end
    __rvv_profile_marker_t10_vcpop_m_m4_scalar_fixed_n2_end:
    .Lrvv_profile_marker_t10_vcpop_m_m4_scalar_fixed_n2_end:

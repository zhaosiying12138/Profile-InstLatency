...
# experiment_id: t10-vcpop-m-m2-n12
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t10_vcpop_m_m2_n12_start, end=__rvv_profile_marker_t10_vcpop_m_m2_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vcpop_m_m2_n12_start
    __rvv_profile_marker_t10_vcpop_m_m2_n12_start:
    .Lrvv_profile_marker_t10_vcpop_m_m2_n12_start:
    vcpop.m x10, v0
    vcpop.m x11, v0
    vcpop.m x12, v0
    vcpop.m x13, v0
    ...
    .globl __rvv_profile_marker_t10_vcpop_m_m2_n12_end
    __rvv_profile_marker_t10_vcpop_m_m2_n12_end:
    .Lrvv_profile_marker_t10_vcpop_m_m2_n12_end:

...
# experiment_id: t12-vcpop-m-m1-k1-scalar-add-fscalar-add
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t12_vcpop_m_m1_k1_scalar_add_fscalar_add_start, end=__rvv_profile_marker_t12_vcpop_m_m1_k1_scalar_add_fscalar_add_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vcpop_m_m1_k1_scalar_add_fscalar_add_start
    __rvv_profile_marker_t12_vcpop_m_m1_k1_scalar_add_fscalar_add_start:
    .Lrvv_profile_marker_t12_vcpop_m_m1_k1_scalar_add_fscalar_add_start:
    vcpop.m x10, v0
    add x20, x6, x7  # independent scalar filler 0
    add x11, x10, x0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t12_vcpop_m_m1_k1_scalar_add_fscalar_add_end
    __rvv_profile_marker_t12_vcpop_m_m1_k1_scalar_add_fscalar_add_end:
    .Lrvv_profile_marker_t12_vcpop_m_m1_k1_scalar_add_fscalar_add_end:

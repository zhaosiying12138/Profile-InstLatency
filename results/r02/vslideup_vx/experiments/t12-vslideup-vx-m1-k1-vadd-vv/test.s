...
# experiment_id: t12-vslideup-vx-m1-k1-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t12_vslideup_vx_m1_k1_vadd_vv_start, end=__rvv_profile_marker_t12_vslideup_vx_m1_k1_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_vslideup_vx_m1_k1_vadd_vv_start
    __rvv_profile_marker_t12_vslideup_vx_m1_k1_vadd_vv_start:
    .Lrvv_profile_marker_t12_vslideup_vx_m1_k1_vadd_vv_start:
    vslideup.vx v2, v0, x6
    vadd.vv v4, v0, v1  # independent filler 0
    vadd.vv v3, v2, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t12_vslideup_vx_m1_k1_vadd_vv_end
    __rvv_profile_marker_t12_vslideup_vx_m1_k1_vadd_vv_end:
    .Lrvv_profile_marker_t12_vslideup_vx_m1_k1_vadd_vv_end:

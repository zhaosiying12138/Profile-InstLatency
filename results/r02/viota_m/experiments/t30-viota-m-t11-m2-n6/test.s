...
# experiment_id: t30-viota-m-t11-m2-n6
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_viota_m_t11_m2_n6_start, end=__rvv_profile_marker_t30_viota_m_t11_m2_n6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_viota_m_t11_m2_n6_start
    __rvv_profile_marker_t30_viota_m_t11_m2_n6_start:
    .Lrvv_profile_marker_t30_viota_m_t11_m2_n6_start:
    viota.m v4, v0
    viota.m v4, v0
    viota.m v4, v0
    viota.m v4, v0
    ...
    .globl __rvv_profile_marker_t30_viota_m_t11_m2_n6_end
    __rvv_profile_marker_t30_viota_m_t11_m2_n6_end:
    .Lrvv_profile_marker_t30_viota_m_t11_m2_n6_end:

...
# experiment_id: t12-viota-m-m2-k11-vadd-vv
# template_id: T12_CONSUMER_RAW_GAP
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t12_viota_m_m2_k11_vadd_vv_start, end=__rvv_profile_marker_t12_viota_m_m2_k11_vadd_vv_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t12_viota_m_m2_k11_vadd_vv_start
    __rvv_profile_marker_t12_viota_m_m2_k11_vadd_vv_start:
    .Lrvv_profile_marker_t12_viota_m_m2_k11_vadd_vv_start:
    viota.m v4, v0
    ...
    .globl __rvv_profile_marker_t12_viota_m_m2_k11_vadd_vv_end
    __rvv_profile_marker_t12_viota_m_m2_k11_vadd_vv_end:
    .Lrvv_profile_marker_t12_viota_m_m2_k11_vadd_vv_end:

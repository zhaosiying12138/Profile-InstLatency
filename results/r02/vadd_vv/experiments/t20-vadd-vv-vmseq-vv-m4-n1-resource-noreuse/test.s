...
# experiment_id: t20-vadd-vv-vmseq-vv-m4-n1-resource-noreuse
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vadd_vv_vmseq_vv_m4_n1_resource_noreuse_start, end=__rvv_profile_marker_t20_vadd_vv_vmseq_vv_m4_n1_resource_noreuse_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vmseq_vv_m4_n1_resource_noreuse_start
    __rvv_profile_marker_t20_vadd_vv_vmseq_vv_m4_n1_resource_noreuse_start:
    .Lrvv_profile_marker_t20_vadd_vv_vmseq_vv_m4_n1_resource_noreuse_start:
    vadd.vv v8, v0, v4
    vmseq.vv v12, v0, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vadd_vv_vmseq_vv_m4_n1_resource_noreuse_end
    __rvv_profile_marker_t20_vadd_vv_vmseq_vv_m4_n1_resource_noreuse_end:
    .Lrvv_profile_marker_t20_vadd_vv_vmseq_vv_m4_n1_resource_noreuse_end:

...
# experiment_id: t20-vadd-vv-vdivu-vv-m4-n2
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n2_start, end=__rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n2_start
    __rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n2_start:
    .Lrvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n2_start:
    vadd.vv v8, v0, v4
    vdivu.vv v12, v0, v4
    vadd.vv v16, v0, v4
    vdivu.vv v20, v0, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n2_end
    __rvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n2_end:
    .Lrvv_profile_marker_t20_vadd_vv_vdivu_vv_m4_n2_end:

...
# experiment_id: t20-vadd-vv-vslideup-vx-m1-n2
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vadd_vv_vslideup_vx_m1_n2_start, end=__rvv_profile_marker_t20_vadd_vv_vslideup_vx_m1_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vslideup_vx_m1_n2_start
    __rvv_profile_marker_t20_vadd_vv_vslideup_vx_m1_n2_start:
    .Lrvv_profile_marker_t20_vadd_vv_vslideup_vx_m1_n2_start:
    vadd.vv v2, v0, v1
    vslideup.vx v3, v0, x6
    vadd.vv v4, v0, v1
    vslideup.vx v5, v0, x6
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vadd_vv_vslideup_vx_m1_n2_end
    __rvv_profile_marker_t20_vadd_vv_vslideup_vx_m1_n2_end:
    .Lrvv_profile_marker_t20_vadd_vv_vslideup_vx_m1_n2_end:

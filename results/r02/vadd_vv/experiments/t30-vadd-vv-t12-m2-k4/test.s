...
# experiment_id: t30-vadd-vv-t12-m2-k4
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vadd_vv_t12_m2_k4_start, end=__rvv_profile_marker_t30_vadd_vv_t12_m2_k4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t12_m2_k4_start
    __rvv_profile_marker_t30_vadd_vv_t12_m2_k4_start:
    .Lrvv_profile_marker_t30_vadd_vv_t12_m2_k4_start:
    vadd.vv v4, v0, v2
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t12_m2_k4_end
    __rvv_profile_marker_t30_vadd_vv_t12_m2_k4_end:
    .Lrvv_profile_marker_t30_vadd_vv_t12_m2_k4_end:

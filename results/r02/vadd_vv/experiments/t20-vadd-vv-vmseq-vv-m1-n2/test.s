...
# experiment_id: t20-vadd-vv-vmseq-vv-m1-n2
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vadd_vv_vmseq_vv_m1_n2_start, end=__rvv_profile_marker_t20_vadd_vv_vmseq_vv_m1_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vadd_vv_vmseq_vv_m1_n2_start
    __rvv_profile_marker_t20_vadd_vv_vmseq_vv_m1_n2_start:
    .Lrvv_profile_marker_t20_vadd_vv_vmseq_vv_m1_n2_start:
    vadd.vv v2, v0, v1
    vmseq.vv v3, v0, v1
    vadd.vv v4, v0, v1
    vmseq.vv v5, v0, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vadd_vv_vmseq_vv_m1_n2_end
    __rvv_profile_marker_t20_vadd_vv_vmseq_vv_m1_n2_end:
    .Lrvv_profile_marker_t20_vadd_vv_vmseq_vv_m1_n2_end:

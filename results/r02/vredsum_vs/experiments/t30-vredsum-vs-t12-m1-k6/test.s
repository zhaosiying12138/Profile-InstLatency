...
# experiment_id: t30-vredsum-vs-t12-m1-k6
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vredsum_vs_t12_m1_k6_start, end=__rvv_profile_marker_t30_vredsum_vs_t12_m1_k6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m1_k6_start
    __rvv_profile_marker_t30_vredsum_vs_t12_m1_k6_start:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m1_k6_start:
    vredsum.vs v2, v0, v1
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m1_k6_end
    __rvv_profile_marker_t30_vredsum_vs_t12_m1_k6_end:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m1_k6_end:

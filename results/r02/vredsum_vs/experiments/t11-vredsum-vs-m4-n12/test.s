...
# experiment_id: t11-vredsum-vs-m4-n12
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t11_vredsum_vs_m4_n12_start, end=__rvv_profile_marker_t11_vredsum_vs_m4_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vredsum_vs_m4_n12_start
    __rvv_profile_marker_t11_vredsum_vs_m4_n12_start:
    .Lrvv_profile_marker_t11_vredsum_vs_m4_n12_start:
    vredsum.vs v8, v0, v4
    vredsum.vs v8, v8, v4
    vredsum.vs v8, v8, v4
    vredsum.vs v8, v8, v4
    ...
    .globl __rvv_profile_marker_t11_vredsum_vs_m4_n12_end
    __rvv_profile_marker_t11_vredsum_vs_m4_n12_end:
    .Lrvv_profile_marker_t11_vredsum_vs_m4_n12_end:

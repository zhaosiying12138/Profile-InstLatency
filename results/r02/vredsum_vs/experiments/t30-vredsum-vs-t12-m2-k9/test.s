...
# experiment_id: t30-vredsum-vs-t12-m2-k9
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vredsum_vs_t12_m2_k9_start, end=__rvv_profile_marker_t30_vredsum_vs_t12_m2_k9_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m2_k9_start
    __rvv_profile_marker_t30_vredsum_vs_t12_m2_k9_start:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m2_k9_start:
    vredsum.vs v4, v0, v2
    ...
    .globl __rvv_profile_marker_t30_vredsum_vs_t12_m2_k9_end
    __rvv_profile_marker_t30_vredsum_vs_t12_m2_k9_end:
    .Lrvv_profile_marker_t30_vredsum_vs_t12_m2_k9_end:

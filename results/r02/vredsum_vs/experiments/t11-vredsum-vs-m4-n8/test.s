...
# experiment_id: t11-vredsum-vs-m4-n8
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t11_vredsum_vs_m4_n8_start, end=__rvv_profile_marker_t11_vredsum_vs_m4_n8_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vredsum_vs_m4_n8_start
    __rvv_profile_marker_t11_vredsum_vs_m4_n8_start:
    .Lrvv_profile_marker_t11_vredsum_vs_m4_n8_start:
    vredsum.vs v8, v0, v4
    vredsum.vs v8, v8, v4
    vredsum.vs v8, v8, v4
    vredsum.vs v8, v8, v4
    ...
    .globl __rvv_profile_marker_t11_vredsum_vs_m4_n8_end
    __rvv_profile_marker_t11_vredsum_vs_m4_n8_end:
    .Lrvv_profile_marker_t11_vredsum_vs_m4_n8_end:

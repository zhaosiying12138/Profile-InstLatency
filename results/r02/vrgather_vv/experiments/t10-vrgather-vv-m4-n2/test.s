...
# experiment_id: t10-vrgather-vv-m4-n2
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t10_vrgather_vv_m4_n2_start, end=__rvv_profile_marker_t10_vrgather_vv_m4_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vrgather_vv_m4_n2_start
    __rvv_profile_marker_t10_vrgather_vv_m4_n2_start:
    .Lrvv_profile_marker_t10_vrgather_vv_m4_n2_start:
    vrgather.vv v8, v0, v4
    vrgather.vv v12, v0, v4
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t10_vrgather_vv_m4_n2_end
    __rvv_profile_marker_t10_vrgather_vv_m4_n2_end:
    .Lrvv_profile_marker_t10_vrgather_vv_m4_n2_end:

...
# experiment_id: t10-vdivu-vv-m2-n2
# template_id: T10_INDEPENDENT_STREAM_THROUGHPUT
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t10_vdivu_vv_m2_n2_start, end=__rvv_profile_marker_t10_vdivu_vv_m2_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t10_vdivu_vv_m2_n2_start
    __rvv_profile_marker_t10_vdivu_vv_m2_n2_start:
    .Lrvv_profile_marker_t10_vdivu_vv_m2_n2_start:
    vdivu.vv v4, v0, v2
    vdivu.vv v6, v0, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t10_vdivu_vv_m2_n2_end
    __rvv_profile_marker_t10_vdivu_vv_m2_n2_end:
    .Lrvv_profile_marker_t10_vdivu_vv_m2_n2_end:

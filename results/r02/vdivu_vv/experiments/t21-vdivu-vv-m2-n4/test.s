...
# experiment_id: t21-vdivu-vv-m2-n4
# template_id: T21_PAIR_WITH_SCALAR
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t21_vdivu_vv_m2_n4_start, end=__rvv_profile_marker_t21_vdivu_vv_m2_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t21_vdivu_vv_m2_n4_start
    __rvv_profile_marker_t21_vdivu_vv_m2_n4_start:
    .Lrvv_profile_marker_t21_vdivu_vv_m2_n4_start:
    vdivu.vv v4, v0, v2
    add x20, x21, x22
    vdivu.vv v6, v0, v2
    add x23, x24, x25
    ...
    .globl __rvv_profile_marker_t21_vdivu_vv_m2_n4_end
    __rvv_profile_marker_t21_vdivu_vv_m2_n4_end:
    .Lrvv_profile_marker_t21_vdivu_vv_m2_n4_end:

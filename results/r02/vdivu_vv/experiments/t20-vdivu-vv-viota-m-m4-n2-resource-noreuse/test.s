...
# experiment_id: t20-vdivu-vv-viota-m-m4-n2-resource-noreuse
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t20_vdivu_vv_viota_m_m4_n2_resource_noreuse_start, end=__rvv_profile_marker_t20_vdivu_vv_viota_m_m4_n2_resource_noreuse_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vdivu_vv_viota_m_m4_n2_resource_noreuse_start
    __rvv_profile_marker_t20_vdivu_vv_viota_m_m4_n2_resource_noreuse_start:
    .Lrvv_profile_marker_t20_vdivu_vv_viota_m_m4_n2_resource_noreuse_start:
    vdivu.vv v8, v0, v4
    viota.m v12, v0
    vdivu.vv v16, v0, v4
    viota.m v20, v0
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vdivu_vv_viota_m_m4_n2_resource_noreuse_end
    __rvv_profile_marker_t20_vdivu_vv_viota_m_m4_n2_resource_noreuse_end:
    .Lrvv_profile_marker_t20_vdivu_vv_viota_m_m4_n2_resource_noreuse_end:

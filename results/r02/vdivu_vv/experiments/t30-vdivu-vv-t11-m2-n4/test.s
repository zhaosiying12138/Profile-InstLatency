...
# experiment_id: t30-vdivu-vv-t11-m2-n4
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t30_vdivu_vv_t11_m2_n4_start, end=__rvv_profile_marker_t30_vdivu_vv_t11_m2_n4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vdivu_vv_t11_m2_n4_start
    __rvv_profile_marker_t30_vdivu_vv_t11_m2_n4_start:
    .Lrvv_profile_marker_t30_vdivu_vv_t11_m2_n4_start:
    vdivu.vv v4, v0, v2
    vdivu.vv v4, v4, v2
    vdivu.vv v4, v4, v2
    vdivu.vv v4, v4, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t30_vdivu_vv_t11_m2_n4_end
    __rvv_profile_marker_t30_vdivu_vv_t11_m2_n4_end:
    .Lrvv_profile_marker_t30_vdivu_vv_t11_m2_n4_end:

...
# experiment_id: t30-vmul-vv-t11-m4-n12
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_vmul_vv_t11_m4_n12_start, end=__rvv_profile_marker_t30_vmul_vv_t11_m4_n12_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t11_m4_n12_start
    __rvv_profile_marker_t30_vmul_vv_t11_m4_n12_start:
    .Lrvv_profile_marker_t30_vmul_vv_t11_m4_n12_start:
    vmul.vv v8, v0, v4
    vmul.vv v8, v8, v4
    vmul.vv v8, v8, v4
    vmul.vv v8, v8, v4
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t11_m4_n12_end
    __rvv_profile_marker_t30_vmul_vv_t11_m4_n12_end:
    .Lrvv_profile_marker_t30_vmul_vv_t11_m4_n12_end:

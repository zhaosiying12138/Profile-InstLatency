...
# experiment_id: t11-vmul-vv-m2-n8
# template_id: T11_SELF_RAW_CHAIN
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t11_vmul_vv_m2_n8_start, end=__rvv_profile_marker_t11_vmul_vv_m2_n8_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t11_vmul_vv_m2_n8_start
    __rvv_profile_marker_t11_vmul_vv_m2_n8_start:
    .Lrvv_profile_marker_t11_vmul_vv_m2_n8_start:
    vmul.vv v4, v0, v2
    vmul.vv v4, v4, v2
    vmul.vv v4, v4, v2
    vmul.vv v4, v4, v2
    ...
    .globl __rvv_profile_marker_t11_vmul_vv_m2_n8_end
    __rvv_profile_marker_t11_vmul_vv_m2_n8_end:
    .Lrvv_profile_marker_t11_vmul_vv_m2_n8_end:

...
# experiment_id: t20-vmul-vv-vredsum-vs-m2-n2
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m2
# markers: start=__rvv_profile_marker_t20_vmul_vv_vredsum_vs_m2_n2_start, end=__rvv_profile_marker_t20_vmul_vv_vredsum_vs_m2_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m2_n2_start
    __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m2_n2_start:
    .Lrvv_profile_marker_t20_vmul_vv_vredsum_vs_m2_n2_start:
    vmul.vv v4, v0, v2
    vredsum.vs v6, v0, v2
    vmul.vv v8, v0, v2
    vredsum.vs v10, v0, v2
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m2_n2_end
    __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m2_n2_end:
    .Lrvv_profile_marker_t20_vmul_vv_vredsum_vs_m2_n2_end:

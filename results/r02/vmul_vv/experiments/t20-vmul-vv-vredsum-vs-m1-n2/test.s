...
# experiment_id: t20-vmul-vv-vredsum-vs-m1-n2
# template_id: T20_PAIRWISE_PIPE_CLASSIFICATION
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t20_vmul_vv_vredsum_vs_m1_n2_start, end=__rvv_profile_marker_t20_vmul_vv_vredsum_vs_m1_n2_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m1_n2_start
    __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m1_n2_start:
    .Lrvv_profile_marker_t20_vmul_vv_vredsum_vs_m1_n2_start:
    vmul.vv v2, v0, v1
    vredsum.vs v3, v0, v1
    vmul.vv v4, v0, v1
    vredsum.vs v5, v0, v1
    # marker end: zero-cost timestamp point at the next instruction PC.
    .globl __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m1_n2_end
    __rvv_profile_marker_t20_vmul_vv_vredsum_vs_m1_n2_end:
    .Lrvv_profile_marker_t20_vmul_vv_vredsum_vs_m1_n2_end:

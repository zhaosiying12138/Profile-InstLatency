...
# experiment_id: t30-vmul-vv-t12-m1-k3
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vmul_vv_t12_m1_k3_start, end=__rvv_profile_marker_t30_vmul_vv_t12_m1_k3_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t12_m1_k3_start
    __rvv_profile_marker_t30_vmul_vv_t12_m1_k3_start:
    .Lrvv_profile_marker_t30_vmul_vv_t12_m1_k3_start:
    vmul.vv v2, v0, v1
    ...
    .globl __rvv_profile_marker_t30_vmul_vv_t12_m1_k3_end
    __rvv_profile_marker_t30_vmul_vv_t12_m1_k3_end:
    .Lrvv_profile_marker_t30_vmul_vv_t12_m1_k3_end:

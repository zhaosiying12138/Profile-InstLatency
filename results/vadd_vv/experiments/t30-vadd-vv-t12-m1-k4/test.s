...
# experiment_id: t30-vadd-vv-t12-m1-k4
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vadd_vv_t12_m1_k4_start, end=__rvv_profile_marker_t30_vadd_vv_t12_m1_k4_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t12_m1_k4_start
    __rvv_profile_marker_t30_vadd_vv_t12_m1_k4_start:
    .Lrvv_profile_marker_t30_vadd_vv_t12_m1_k4_start:
    vadd.vv v2, v0, v1
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t12_m1_k4_end
    __rvv_profile_marker_t30_vadd_vv_t12_m1_k4_end:
    .Lrvv_profile_marker_t30_vadd_vv_t12_m1_k4_end:

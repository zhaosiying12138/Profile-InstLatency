...
# experiment_id: t30-vadd-vv-t12-m4-k6
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m4
# markers: start=__rvv_profile_marker_t30_vadd_vv_t12_m4_k6_start, end=__rvv_profile_marker_t30_vadd_vv_t12_m4_k6_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t12_m4_k6_start
    __rvv_profile_marker_t30_vadd_vv_t12_m4_k6_start:
    .Lrvv_profile_marker_t30_vadd_vv_t12_m4_k6_start:
    vadd.vv v8, v0, v4
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t12_m4_k6_end
    __rvv_profile_marker_t30_vadd_vv_t12_m4_k6_end:
    .Lrvv_profile_marker_t30_vadd_vv_t12_m4_k6_end:

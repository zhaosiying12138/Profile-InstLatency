...
# experiment_id: t30-vadd-vv-t11-m1-n8
# template_id: T30_LMUL_SCALING
# vector_shape: e32,m1
# markers: start=__rvv_profile_marker_t30_vadd_vv_t11_m1_n8_start, end=__rvv_profile_marker_t30_vadd_vv_t11_m1_n8_end
#
...
_start:
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t11_m1_n8_start
    __rvv_profile_marker_t30_vadd_vv_t11_m1_n8_start:
    .Lrvv_profile_marker_t30_vadd_vv_t11_m1_n8_start:
    vadd.vv v2, v0, v1
    vadd.vv v2, v2, v1
    vadd.vv v2, v2, v1
    vadd.vv v2, v2, v1
    ...
    .globl __rvv_profile_marker_t30_vadd_vv_t11_m1_n8_end
    __rvv_profile_marker_t30_vadd_vv_t11_m1_n8_end:
    .Lrvv_profile_marker_t30_vadd_vv_t11_m1_n8_end:
